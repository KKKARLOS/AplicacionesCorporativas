...
namespace GASVI.DAL
{
    ...
    public partial class POSICIONGV
    {
        ...
        public static bool EsDesplazamientoECOenVUP(SqlTransaction tr, int t615_iddesplazamiento)
        {
            SqlParameter[] aParam = new SqlParameter[1];
            int i = 0;
            aParam[i++] = ParametroSql.add("@t615_iddesplazamiento", SqlDbType.Int, 4, t615_iddesplazamiento);
            ...
            if (tr == null)
                return (System.Convert.ToInt32(SqlHelper.ExecuteScalar("GVT_ESDESPLAZAMIENTOVUP", aParam)) == 1) ? true : false;
            else
                return (System.Convert.ToInt32(SqlHelper.ExecuteScalarTransaccion(tr, "GVT_ESDESPLAZAMIENTOVUP", aParam)) == 1) ? true : false;
        }
