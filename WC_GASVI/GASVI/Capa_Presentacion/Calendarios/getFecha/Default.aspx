<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Calendario_getFecha" EnableEventValidation="false" %>
...
<ucproc:Procesando ID="Procesando1" runat="server" />
    ...
    <div id="divMesesInicio">
        <div class="TituloMeses">Fecha de contabilización</div>
        <div id="divLiteralFechaInicio" class="LiteralFecha" onclick="setMesSeleccionado();"></div>
            <span class="spanBotones">
                <img name="btnAntRegInicio" onclick="setAntSig('A')" style="cursor:pointer;" border="0" src="../../../images/btnAntRegOn.gif" width="24" height="20" />&nbsp;
                <img name="btnSigRegInicio" onclick="setAntSig('S')" style="cursor:pointer;" border="0" src="../../../images/btnSigRegOn.gif" width="24" height="20" />
            </span>
