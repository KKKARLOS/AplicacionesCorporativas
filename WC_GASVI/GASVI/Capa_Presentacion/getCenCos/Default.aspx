...
<head id="Head1" runat="server">
    <title> ::: GASVI 2.0 ::: - Selección de centros de costes</title>
...
<body onload="init()" onunload="unload()">
    <form id="Form1" name="frmPrincipal" runat="server">
        ...
        <center>
                        ...
                        <table id="tblCabecera" style="width:350px; height:17px; margin-top:10px;">
	                        <tr class="TBLINI">
		                        <td style="padding-left:68px;">
		                            Denominación
		                            <img alt="" class="ICO" id="imglupa" style="display:none; cursor:pointer" onclick="buscarSiguiente('tblCatCenCos',1,'divCatalogo','imgLupa')" height="11px" src="../../Images/imgLupaMas.gif" width="20px" tipolupa="2" />
                                    <img alt="" class="ICO" style="cursor:pointer; display:none;" onclick="buscarDescripcion('tblCatCenCos',1,'divCatalogo','imgLupa',event)" height="11px" src="../../Images/imgLupa.gif" width="20px" tipolupa="1" />	
                                </td>
	                        </tr>
                        </table>
                        <div id="divCatalogo" style="overflow-x:hidden; overflow:auto; width:366px; height:360px;">
            ...
            <table style="width:100px; margin-top:5px;text-align:center">
            <tr>
