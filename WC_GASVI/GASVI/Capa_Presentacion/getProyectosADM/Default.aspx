    ...
    <body onload="init()" onunload="unload()">
        <form name="frmPrincipal" runat="server">
            ...
            <center>
	            ...
	            <tr>
		            <td>
			            <table id="tblTitulo" cellpadding="0" style="height:17px; width:940px">
			                <colgroup>
				            ...
				            <tr class="TBLINI">
					            ...
					            <td style="text-align:right;padding-right:3px">
					                <img style="cursor:pointer; display:none;" onclick="buscarDescripcion('tblCatProy',2,'divCatalogo','imgLupa1',event)"
							            height="11" src="../../Images/imgLupa.gif" width="20" tipolupa="1">
							        <img id="imgLupa1" style="cursor:pointer; display:none;" onclick="buscarSiguiente('tblCatProy',2,'divCatalogo','imgLupa1')"
							            height="11" src="../../Images/imgLupaMas.gif" width="20" tipolupa="2">
							        <img style="cursor:pointer; height:11px;" src="../../Images/imgFlechas.gif" width="6" useMap="#img1" border="0">
					                <map name="img1">
					                    <area onclick="ot('tblCatProy', 2, 0, 'num', 'scrollTablaProy()')" shape="RECT" coords="0,0,6,5">
					                    <area onclick="ot('tblCatProy', 2, 1, 'num', 'scrollTablaProy()')" shape="RECT" coords="0,6,6,11">
				                    </map>Nº
					            </td>
					            <td>
					                <img style="cursor:pointer" height="11" src="../../Images/imgFlechas.gif" width="6" useMap="#img2" border="0">
					                <map name="img2">
					                    <area onclick="ot('tblCatProy', 3, 0, '', 'scrollTablaProy()')" shape="RECT" coords="0,0,6,5">
					                    <area onclick="ot('tblCatProy', 3, 1, '', 'scrollTablaProy()')" shape="RECT" coords="0,6,6,11">
				                    </MAP>&nbsp;Proyecto&nbsp;
				                    <img id="imgLupa2" style="cursor:pointer; display:none;" onclick="buscarSiguiente('tblCatProy',3,'divCatalogo','imgLupa2')"
						                height="11" src="../../Images/imgLupaMas.gif" width="20" tipolupa="2">
						            <img style="cursor:pointer; display:none;" onclick="buscarDescripcion('tblCatProy',3,'divCatalogo','imgLupa2',event)"
						                height="11" src="../../Images/imgLupa.gif" width="20" tipolupa="1">
					            </td>
					            <td>
					                <img style="cursor:pointer" height="11" src="../../Images/imgFlechas.gif" width="6" useMap="#img3" border="0">
					                <map name="img3">
					                    <area onclick="ot('tblCatProy', 4, 0, '', 'scrollTablaProy()')" shape="RECT" coords="0,0,6,5">
					                    <area onclick="ot('tblCatProy', 4, 1, '', 'scrollTablaProy()')" shape="RECT" coords="0,6,6,11">
				                    </map>&nbsp;Cliente&nbsp;
				                    <img id="imgLupa3" style="cursor:pointer; display:none;" onclick="buscarSiguiente('tblCatProy',4,'divCatalogo','imgLupa3')"
						                height="11" src="../../Images/imgLupaMas.gif" width="20" tipolupa="2">
						            <img style="cursor:pointer; display:none;" onclick="buscarDescripcion('tblCatProy',4,'divCatalogo','imgLupa3',event)"
						                height="11" src="../../Images/imgLupa.gif" width="20" tipolupa="1"> 
					            </td>
					            <td>
					                <img style="cursor:pointer" height="11" src="../../Images/imgFlechas.gif" width="6" useMap="#img4" border="0">
					                <map name="img4">
					                    <area onclick="ot('tblCatProy', 5, 0, '', 'scrollTablaProy()')" shape="RECT" coords="0,0,6,5">
					                    <area onclick="ot('tblCatProy', 5, 1, '', 'scrollTablaProy()')" shape="RECT" coords="0,6,6,11">
				                    </map>&nbsp;<label id="lblNodo2" class="TBLINI" runat="server">Nodo</label>&nbsp;
				                    <img id="imgLupa4" style="cursor:pointer; display:none;" onclick="buscarSiguiente('tblCatProy',6,'divCatalogo','imgLupa4')"
						                height="11" src="../../Images/imgLupaMas.gif" width="20" tipolupa="2">
						            <img style="cursor:pointer; display:none;" onclick="buscarDescripcion('tblCatProy',5,'divCatalogo','imgLupa4',event)"
						                height="11" src="../../Images/imgLupa.gif" width="20" tipolupa="1"> 
					            </td>
				            </tr>
			            </table>
			            <div id="divCatalogo" style="overflow-x:hidden; overflow:auto; width:956px; height:480px;" onscroll="scrollTablaProy();">
