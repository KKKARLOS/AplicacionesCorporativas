<%@ Control Language="c#" Inherits="GASVI.Capa_Presentacion.UserControls.Novedades" CodeFile="Novedades.ascx.cs" %>
<STYLE type=text/css>
.msn {
		...
		<SPAN style="FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif">
			<P style="FONT-SIZE: 11px; PADDING-TOP: 0px"><br />
				<TABLE Border=0 CellPadding=1 CellSpacing=0 Width=100%>
					<TR><TD Width=4></TD>
						<TD><a href="<%=Session["GVT_strServer"].ToString() %>Capa_Presentacion/Ayuda/Novedades/Default.aspx"><img Border=0 SRC="<%=strUrl%>imgInfo.gif" width=48 height=48></a></TD>
						<TD Width=4></TD>
						<TD style="vertical-align: middle" class=msn>
						Se han producido novedades en la aplicación GASVI.<br /><br />Para verlas, pulse <A href="<%=Session["GVT_strServer"].ToString() %>Capa_Presentacion/Ayuda/Novedades/Default.aspx" style="color:Red">aquí</A>.
						</TD>
					</TR>
				</TABLE>
			</P>
