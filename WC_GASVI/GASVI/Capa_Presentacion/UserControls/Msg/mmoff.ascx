...
<colgroup>
    ...
    <tr> 
        ...
        <td id="tdMsg3" class="tdMsg3Inf" style="cursor:pointer;" onclick="hide_mmoff();"><img id="imgPopUpClose" src="<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/Msg/Images/popup_close.png" style="cursor:pointer; position:absolute; top: -9px; right:-10px; z-index: 9999;" onclick="hide_mmoff();" /></td>
    </tr>
    <tr id="trMsg">
...
<img id="imgPopUpCloseIE" src="<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/Msg/Images/popup_close.png" style="display:none; cursor:pointer; z-index: 9999;" onclick="hide_mmoff();" />
<script language="JavaScript" src="<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/Msg/Functions/funciones.js" type="text/Javascript"></script>
<script type="text/javascript" language="javascript">
    ...
    function setEstiloMMOff(sTipo){
        switch(sTipo.toLowerCase()){
            case "inf":
            case "infper":
                $I("imgIconoMsg").setAttribute("src", "<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/Msg/Images/Information/imgIcono.png");
            ...
            case "war":
            case "warper":
                $I("imgIconoMsg").setAttribute("src", "<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/Msg/Images/Warning/imgIcono.png");
            ...
            case "suc":
            case "sucper":
                $I("imgIconoMsg").setAttribute("src", "<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/Msg/Images/Success/imgIcono.png");
                ...
                break;
            case "err":
                $I("imgIconoMsg").setAttribute("src", "<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/Msg/Images/Error/imgIcono.png");
