...
<link href="<%=Session["GVT_strServer"] %>App_Themes/Corporativo/jquery-ui-1.8.17.custom.css" rel="stylesheet" />
<!--
<script src="<%=Session["GVT_strServer"] %>Javascript/jquery-1.7.1/jquery-1.7.1.min.js"></script>
<script src="<%=Session["GVT_strServer"] %>Javascript/jquery-1.7.1/ui-1.8.17/jquery-ui-1.8.17.custom.js"></script>
-->
<script type="text/javascript">
    ...
    function jqConfirm(titulo, mensaje, botonAceptarTexto, botonCancelarTexto, tipoDialogo, ancho) {
        ...
        switch (tipoDialogo.toLowerCase()) {
            case "ques":
                imagePath = "<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/JQConfirm/Images/QuestionIcon.png";
                break;
            case "inf":
                imagePath = "<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/JQConfirm/Images/InformationIcon.png";
                break;
            case "err":
                imagePath = "<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/JQConfirm/Images/ErrorIcon.png"
                break;
            case "ok":
                imagePath = "<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/JQConfirm/Images/OkIcon.png"
                break;
            case "war":
                imagePath = "<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/JQConfirm/Images/WarningIcon.png"
                break;
            default:
                imagePath = "<%=Session["GVT_strServer"] %>Capa_Presentacion/UserControls/JQConfirm/Images/QuestionIcon.png";
        }
