	...
	function getCalculadora(nLeft, nTop){
	    try{
	        if (typeof(window.frames.iFrameCalculadora) != "undefined"){
    	        ...
    	        setTimeout(function(){window.frames.iFrameCalculadora.focus()},10); 
...
<iframe name="iFrameCalculadora" id="iFrameCalculadora" 
            scrolling="no" 
            src="<% =Session["GVT_strServer"].ToString() %>Capa_Presentacion/UserControls/Calculadora/Default.aspx" 
