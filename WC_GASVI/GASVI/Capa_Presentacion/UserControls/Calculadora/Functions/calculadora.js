...
function evaluate()
{
	try {
	    bEvaluacionOK = true;
	    var val = redondeo(eval(document.calculator.expr.value),2);	    
	}
	catch(e) {
		error("Operación incorrecta");
...
function llevar()
{
    try{
        ...
        if (typeof(oDestino) != "undefined" && oDestino != ""){
	        ...
	        window.top.document.getElementById(window.top.oDestinoCalculadora).style.backgroundImage = "";
	        window.top.document.getElementById(window.top.oDestinoCalculadora).style.backgroundRepeat= "";
	        window.top.document.getElementById(window.top.oDestinoCalculadora).focus();
	        setTimeout(function () { window.top.focus() }, 10);
            try {
                var event;
                ...
                if (document.createEvent) {
                    window.top.document.getElementById(window.top.oDestinoCalculadora).dispatchEvent(event);
                } else {
                    window.top.document.getElementById(window.top.oDestinoCalculadora).fireEvent("on" + event.eventType, event);
                }        
...
function setOpacityCalc()
{
    try{
        ...
        window.top.document.getElementById("iFrameCalculadora").style.filter = "progid:DXImageTransform.Microsoft.Alpha(Opacity=" + nOpacidadCalculadora + ")";
        window.top.document.getElementById("iFrameCalculadora").style.opacity = parseInt((nOpacidadCalculadora / 100),10);
