...
public partial class Capa_Presentacion_Administracion_Descargar : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try{
            ...
            if (HttpContext.Current.Cache["ConsultaADM_" + Session["GVT_IDFICEPI_ENTRADA"].ToString()] != null)
                ds = (DataSet)HttpContext.Current.Cache["ConsultaADM_" + Session["GVT_IDFICEPI_ENTRADA"].ToString()];
    ...
    private void getExcel(DataSet ds)
    {
        ...
        try
        {
            ...
            string sNombreArchivo = "Consulta_Administrador_" + Session["GVT_IDFICEPI_ENTRADA"].ToString() + sExtension;
