...
namespace SUPER.DAL
{
    public class CampoPT
    {
                                              ...
                                              ArrayList lProy, ArrayList lCli, ArrayList lCR)
        {
            ...
            if (tr == null)
                return SqlHelper.ExecuteSqlDataReader("SUP_CAMPOPT_CAT", aParam);
            else
                return SqlHelper.ExecuteSqlDataReaderTransaccion(tr, "SUP_CAMPOPT_CAT", aParam);
        }
        ...
        public static SqlDataReader obtenerCamposValor(SqlTransaction tr, int nIdPT)
        {
            ...
            if (tr == null)
                return SqlHelper.ExecuteSqlDataReader("SUP_CAMPOPT_C", aParam);
            else
                return SqlHelper.ExecuteSqlDataReaderTransaccion(tr, "SUP_CAMPOPT_C", aParam);
        }
        ...
        public static SqlDataReader CatalogoByPT(int t331_idpt)
        {
            ...
            return SqlHelper.ExecuteSqlDataReader("SUP_CAMPOS_CByt331_idpt", aParam);
        }
    }
}