    ...
    internal class FiguraAreaPreventa
    {
        ...
        internal int Delete(Int32 ta200_idareapreventa, Int32 t001_idficepi)
        {
            try
            {
                ...
                return (int)cDblib.Execute("SIC_AREAPREVENTA_FIGURAS_USUARIO_D", dbparams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        internal int DeleteFigura(Int32 ta200_idareapreventa, Int32 t001_idficepi, string ta202_figura)
        {
            try
            {
                SqlParameter[] dbparams = new SqlParameter[3] {
					Param(enumDBFields.ta200_idareapreventa, ta200_idareapreventa),
					Param(enumDBFields.t001_idficepi, t001_idficepi),
					Param(enumDBFields.ta202_figura, ta202_figura),
				};

                return (int)cDblib.Execute("SIC_AREAPREVENTA_FIGURAS_D", dbparams);
            }
            catch (Exception ex)
            {
                throw ex;
