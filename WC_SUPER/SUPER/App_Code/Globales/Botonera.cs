...
namespace SUPER.Capa_Negocio
{
    ...
    public class CBotonera
    {
        ...
        public CBotonera()
        {
            ...
            htBotones.Add(83, new Boton("IcoTrasExc", "Realiza el traspaso IAP del mes siguiente al mes guía, para los proyectos de los nodos identificados en la columna 'Traspaso IAP Exc.'", "Trasp. Exc"));
            ...
            htBotones.Add(92, new Boton("festivoProv", "Asigna los días festivos especificados a la provincia vinculada a ese calendario", "Festivos Prov."));
            #endregion 

            #region Relación de Botoneras
            htBotoneras.Add(1, new string[] { "3", "" });
            htBotoneras.Add(2, new string[] { "2,30,7,43", "" });
            htBotoneras.Add(3, new string[] { "4,26,27,28,29,31,92,6", "4" });
            ...
            htBotoneras.Add(21, new string[] { "4,42,44,46,62,81,18,53,71", "4,42,44,46,62,81,53,18" });
            ...
            htBotoneras.Add(43, new string[] { "50", "50" });
            ...
            htBotoneras.Add(47, new string[] { "50,70,7", "" });
