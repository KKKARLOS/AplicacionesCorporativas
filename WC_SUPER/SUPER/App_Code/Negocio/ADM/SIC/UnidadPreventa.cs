...
namespace IB.SUPER.ADM.SIC.BLL
{
    public class UnidadPreventa : IDisposable
    {
        ...
        public List<Models.UnidadPreventa> Catalogo(Models.UnidadPreventa oUnidadPreventaFilter)
        {
            OpenDbConn();
        ...
        public short Insert(Models.UnidadPreventa oUnidadPreventa)
        {
            ...
            try
            {
                ...
                short idUnidadPreventa = cUnidadPreventa.Insert(oUnidadPreventa);
        ...
        public int Update(Models.UnidadPreventa oUnidadPreventa)
        {
