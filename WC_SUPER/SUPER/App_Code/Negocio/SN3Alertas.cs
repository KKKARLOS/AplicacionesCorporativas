...
namespace SUPER.BLL
{
    ...
    public partial class SN3Alertas
    {
                ...
                foreach (string sAlerta in aAlerta)
                {
                    ...
                    switch (aDatosAlerta[0])
                    {
                        case "U":
                            ...
                            DAL.SN3Alertas.Update(tr, int.Parse(aDatosAlerta[1].ToString()), nPar1, nPar2, nPar3);
                            break;
                    }
                }
        ...
        public static string CatalogoById(int t393_idsupernodo3)
        {
            ...
            SqlDataReader dr = SUPER.DAL.SN3Alertas.CatalogoById(null, t393_idsupernodo3);
            while (dr.Read())
            {
                sb.Append("<tr id=" + dr["t823_idsn3alertas"].ToString());
                ...
                if (dr["t820_parametro1"].ToString() == "")
                    ...
                    sb.Append("<td class='tdcol'><input type='text' class='txtNumL' SkinID='Numero' onkeypress='vtn(event);' onfocus='fn(this,8,0)' style='width:55px' value='" + Utilidades.getInt(dr["t823_parametro1"].ToString()) + "' maxlength='8'></td>");
                ...
                if (dr["t820_parametro2"].ToString() == "")
                    ...
                    sb.Append("<td class='tdcol'><input type='text' class='txtNumL' SkinID='Numero' onkeypress='vtn(event);' onfocus='fn(this,8,0)' style='width:55px' value='" + Utilidades.getInt(dr["t823_parametro2"].ToString()) + "' maxlength='8'></td>");
                ...
                if (dr["t820_parametro3"].ToString() == "")
                    ...
                    sb.Append("<td class='tdcol'><input type='text' class='txtNumL' SkinID='Numero' onkeypress='vtn(event);' onfocus='fn(this,8,0)' style='width:55px' value='" + Utilidades.getInt(dr["t823_parametro3"].ToString()) + "' maxlength='8'></td>");
                sb.Append("</tr>");
            }
            dr.Close();
            dr.Dispose();
