...
namespace SUPER.Capa_Negocio
{
    ...
    {
        public static DataSet ValidarSuperCostes(int iAnoMes)
        {
            SqlParameter[] aParam = new SqlParameter[1];
            aParam[0] = new SqlParameter("@MesInicio", SqlDbType.Int, 4);
            aParam[0].Value = iAnoMes;

            return SqlHelper.ExecuteDataset("SUP_RECALCOSTESSUPER_VALIDACION", aParam);
        }
        ...
        public static SqlDataReader GetCatalogo()
        {
            ...
            return SqlHelper.ExecuteSqlDataReader("SUP_RECALCULOCOSTESSUPER_CAT", aParam);
        }
        ...
        public static void DeleteAll(SqlTransaction tr)
        {
            ...
            if (tr == null)
                SqlHelper.ExecuteNonQuery("SUP_RECALCULOCOSTESSUPER_D_ALL", aParam);
            else
                SqlHelper.ExecuteNonQueryTransaccion(tr, "SUP_RECALCULOCOSTESSUPER_D_ALL", aParam);
        }
