	...
	public partial class EXCLUIDOS_CTP
	{
        ...
        public static string Obtener()
        {
            StringBuilder sb = new StringBuilder();
                ...
                SqlDataReader dr = SUPER.DAL.EXCLUIDOS_CTP.Catalogo();
        ...
        public static string obtenerProfesionales(string sAp1, string sAp2, string sNombre)
        {
            ...
            //try
            //{
                SqlDataReader dr = SUPER.Capa_Negocio.USUARIO.GetProfAdm(Utilidades.unescape(sAp1), Utilidades.unescape(sAp2), Utilidades.unescape(sNombre),
                                        false, null);
            ...
            try
            {
                ...
                if (strProfesionales != "")//No se ha modificado nada de la pestaña de Figuras
                {
                    ...
                    foreach (string oProfesional in aProfesionales)
                    {
                        ...
                        {
                            case "I":
                                SUPER.DAL.EXCLUIDOS_CTP.Insert(tr, int.Parse(aValores[1]));
                                if (sElementosInsertados == "") sElementosInsertados = aValores[1];
                                else sElementosInsertados += "//" + aValores[1];
                                break;
                            case "D":
                                SUPER.DAL.EXCLUIDOS_CTP.Delete(tr, int.Parse(aValores[1]));
                                break;
                        }
                    }
                }
