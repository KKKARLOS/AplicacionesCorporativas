...
namespace SUPER.BLL
{
    ...
    public partial class SN4Alertas
    {
        ...
        public static string CatalogoById(int t394_idsupernodo4)
        {
            ...
            SqlDataReader dr = SUPER.DAL.SN4Alertas.CatalogoById(null, t394_idsupernodo4);
            while (dr.Read())
            {
                sb.Append("<tr id=" + dr["t822_idsn4alertas"].ToString());
                ...
                if (dr["t820_parametro1"].ToString() == "")
                    ...
                    sb.Append("<td class='tdcol'><input type='text' class='txtNumL' SkinID='Numero' onkeypress='vtn(event);' onfocus='fn(this,8,0)' style='width:55px' value='" + Utilidades.getInt(dr["t822_parametro1"].ToString()) + "' maxlength='8'></td>");
                ...
                if (dr["t820_parametro2"].ToString() == "")
                    ...
                    sb.Append("<td class='tdcol'><input type='text' class='txtNumL' SkinID='Numero' onkeypress='vtn(event);' onfocus='fn(this,8,0)' style='width:55px' value='" + Utilidades.getInt(dr["t822_parametro2"].ToString()) + "' maxlength='8'></td>");
                ...
                if (dr["t820_parametro3"].ToString() == "")
                    ...
                    sb.Append("<td class='tdcol'><input type='text' class='txtNumL' SkinID='Numero' onkeypress='vtn(event);' onfocus='fn(this,8,0)' style='width:55px' value='" + Utilidades.getInt(dr["t822_parametro3"].ToString()) + "' maxlength='8'></td>");
                sb.Append("</tr>");
            }
            dr.Close();
            dr.Dispose();
