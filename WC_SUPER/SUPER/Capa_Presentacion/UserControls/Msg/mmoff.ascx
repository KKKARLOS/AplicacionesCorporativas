...
<script src="<%=Session["strServer"] %>Capa_Presentacion/UserControls/Msg/Functions/funciones.js" type="text/Javascript"></script>
    ...
    function setEstiloMMOff(sTipo){
        switch(sTipo.toLowerCase()){
            ...
            case "infper":
                ...
                $I("trMsg").style.backgroundColor = "#d1e4f3";
                $I("trMsg").style.color = "#3b3019";
                $I("trMsg").style.fontFamily = "Arial";
                $I("trMsg").style.fontSize = "9pt";
            ...
            case "warper":
                ...
                $I("trMsg").style.backgroundColor = "#fff5af";
                $I("trMsg").style.color = "#3b3019";
                $I("trMsg").style.fontFamily = "Arial";
                $I("trMsg").style.fontSize = "9pt";
            ...
            case "sucper":
                ...
                $I("trMsg").style.backgroundColor = "#d0ec7b";
                $I("trMsg").style.color = "#3b3019";
                $I("trMsg").style.fontFamily = "Arial";
                $I("trMsg").style.fontSize = "9pt";
            ...
            case "err":
                ...
                $I("trMsg").style.backgroundColor = "#fccac1";
                $I("trMsg").style.color = "#3b3019";
                $I("trMsg").style.fontFamily = "Arial";
                $I("trMsg").style.fontSize = "9pt";
