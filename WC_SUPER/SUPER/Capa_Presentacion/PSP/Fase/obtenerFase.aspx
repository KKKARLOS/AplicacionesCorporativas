<%@ Page Language="c#" CodeFile="obtenerFase.aspx.cs" Inherits="obtenerFase" %>
...
<head id="Head1" runat="server">
	<title> ::: SUPER ::: - Selección de fase</title>
    ...
    <tr>
	    <td>
		    ...
		    <table style="width:400px" align="center">
			     ...
			     <tr>
				    <td>
					    <label style="width:83px;">Proy. técnico</label>
					    <asp:TextBox ID="txtPT" runat="server" style="width:296px" readonly="true" />
