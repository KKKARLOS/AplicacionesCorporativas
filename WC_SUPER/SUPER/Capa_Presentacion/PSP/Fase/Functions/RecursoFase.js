...
var oRecActivo;
function objRecurso(opcionBD, idFase, idRecurso, nombre, fip, ffe, idTarifa, estado, indicaciones, bNotifExceso){
...
function insertarRecursoEnArray(opcionBD, idFase, idRecurso, nombre, fip, ffe, idTarifa, estado, indicaciones, bNotifExceso){
    try{
        oRec = new objRecurso(opcionBD, idFase, idRecurso, nombre, fip, ffe, idTarifa, estado, indicaciones, bNotifExceso);
