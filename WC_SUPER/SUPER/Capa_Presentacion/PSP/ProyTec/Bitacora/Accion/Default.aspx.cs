...
public partial class Default : System.Web.UI.Page, ICallbackEventHandler
{
    ...
    private static string EnviarCorreoAlerta(string sTipo, string strDatosTarea, string slMails, string slIntegrantes, string sIdResponsable, bool bAlta)
    {
        ...
        try
        {
            ...
            sbuilder.Append("<label style='width:120px'>Proyecto técnico: </label>" + aDatosTarea[12] + @" - " + aDatosTarea[13] + "<br>");
        ...
        {
            sResul = "Error@#@" + 
                Errores.mostrarError("Error al enviar correo de acción de Bitácora de PT (sIdResponsable=" + sIdResponsable + 
                " sIdAccion=" + sIdAccion +
