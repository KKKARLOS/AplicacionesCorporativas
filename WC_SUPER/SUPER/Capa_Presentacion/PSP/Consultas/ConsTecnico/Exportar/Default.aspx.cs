...
public partial class EXPORTARCONSPROFIND : System.Web.UI.Page
{
...
//				modificar localizaciones 
            ...
            try
            {
                rdProyecto.Load(Server.MapPath(".") + @"\sup_consumosprofesional.rpt");
            }
            catch (Exception ex)
            {
                rdProyecto.Close();
            ...
            try
            {
                ...
                rdProyecto.SetParameterValue("@Tecnico", Request.Form[pf + "txtCodTecnico"]);
                rdProyecto.SetParameterValue("@fDesde", Request.Form[pf + "txtValIni"]);
                rdProyecto.SetParameterValue("@fHasta", Request.Form[pf + "txtValFin"]);
                ...
                rdProyecto.SetParameterValue("profesional", Request.Form[pf + "txtNombreTecnico"]);
