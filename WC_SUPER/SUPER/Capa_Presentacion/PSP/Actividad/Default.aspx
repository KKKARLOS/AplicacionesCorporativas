...
<head  runat="server">
    <title> ::: SUPER ::: - Detalle de actividad</title>
	...
	<script src="Functions/RecursoActividad.js" type="text/Javascript"></script>
...
<center>
<table id="tabla" style="padding:10px; width:920px; margin-top:10px;">
	<tr>
		<td>
			...
			<eo:MultiPage runat="server" id="mpContenido" CssClass="FMP" Width="100%" Height="560px">
	                    ...
	                    <td>
							<fieldset style="width:800px; margin-left:4px;">
                                ...
                                <table style="width:100%" cellpadding="4px">
                                    ...
                                    <tr>
                                        <td>
					                        <label style="width:105px">Fase</label>
					                        <asp:TextBox ID="txtDesFase" runat="server" style="width:650px" readonly="true" />
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                    ...
                    <tr>
	                    <td>
							<fieldset style="width:800px; margin-left:4px; margin-top:5px;">
								<legend>Identificación de actividad</legend>
                                <table align="center" border="0" class="texto" width="100%" cellpadding="5" cellspacing="0">
                                    <tr>
                                        <td><label style="width:105px" ondblclick="verCodigo()">Denominación</label>
                                            <asp:TextBox ID="txtDesActividad" runat="server" Style="width:650px" MaxLength=100 onKeyUp="aG(0);"></asp:TextBox>
                                            <asp:TextBox ID="txtIdActividad" runat="server" style="width:0px;visibility:hidden;" readonly="true"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                        </fieldset>
	                            ...
	                            <tr>
                                    ...
                                    <td>                            
						                <fieldset style="width:315px;"><legend>Previsión</legend>
                                            <table style="width:233px; margin-left:60px;" cellpadding="5px">
                                                <tr>
                                                    <td>
                                                        Fin
               ...
               <eo:PageView ID="PageView2" CssClass="PageView" runat="server" align="center">	
                <!-- Pestaña 2 Técnicos-->
			        ...
			        <eo:MultiPage runat="server" id="mpContenidoProf" CssClass="FMP" Width="100%" Height="520px">
                        ...
                        <table width="100%" style="text-align:left; margin-left:10px;">		
							        ...
							        <fieldset style="width:850px; height: 330px;">
                                        ...
                                        <table width="100%" cellpadding="5">
                                            ...
                                            <tr>
                                                ...
                                                <td><table id="tblTitRecAsig" style="width: 380px; height: 17px">
	                            ...
	                            <td>
							        <fieldset style="width:850px; height: 120px;">
								        <legend>Indicaciones del responsable al profesional asignado seleccionado</legend>
                                            <table class="texto" style="width:100%; margin-top:10px;" cellpadding="5" cellspacing="0" >
                                                <tr>
                            ...
                            <tr>
                                <td>
                                    <fieldset style="width:90%; height: 115px;"><legend>Asignación automática de profesionales</legend>
                                        ...
                                        <br /><br /><span style="color:Red; font-size:9pt;">¡Atención! La activación de esta segunda opción, asignará de forma automática a las tareas dependientes de esta Actividad a todos los profesionales pertenecientes al <%= Estructura.getDefLarga(Estructura.sTipoElem.NODO) %> del proyecto, que son <label id="lblNumEmp" style="width:40px;color:Blue; font-size:12pt;" ></label></span>
                                    </fieldset>
                                </td>
                                <td>
	                            ...
	                            <td colspan="2">
							        <fieldset style="width:850px; height: 310px;">
                                        ...
                                        <table style="width:830px;" cellpadding="5px">
                                            ...
                                            <tr>
                                                <td>
                                                <span id="Span1" style="display:block" class="texto">
                                                    &nbsp;Apellido1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    &nbsp;Apellido2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    &nbsp;Nombre<br />
                                                    <asp:TextBox ID="txtApe1Pool" runat="server" Width="110px" onkeypress="javascript:if(event.keyCode==13){mostrarRelacionTecnicos3('N','','','');event.keyCode=0;}" MaxLength="50" />
                                                    <asp:TextBox ID="txtApe2Pool" runat="server" Width="110px" onkeypress="javascript:if(event.keyCode==13){mostrarRelacionTecnicos3('N','','','');event.keyCode=0;}" MaxLength="50" />
                                                    <asp:TextBox ID="txtNomPool" runat="server" Width="110px" onkeypress="javascript:if(event.keyCode==13){mostrarRelacionTecnicos3('N','','','');event.keyCode=0;}" MaxLength="50" />
                                                </span>
                                                </td>
                                                <td></td> 
                                                <td></td>
               ...
               <!-- Pestaña 3 tareas-->
               <table width="100%" style="text-align:left;margin-left:20px; margin-top:10px;">
                    <tr>
                        <td align="left">
                           <!-- <asp:CheckBox ID="chkEstr" runat="server" Text=" Mostrar estructura" Width="100%" onClick="getDatos(2);" />-->&nbsp;
                        </td>
                    </tr>
                    <tr>
	                    <td>
               ...
               <eo:PageView ID="PageView7" CssClass="PageView" runat="server" align="center">	
               <!-- Pestaña 5 Documentación -->
               <table style="text-align:left;width:950px;margin-left:25px; margin-top:10px;">
                    <tr>
	                    <td>
...
<center>
    <table id="tblBotones" align="center" style="margin-top:15px;" width="50%">
        <tr>
	        ...
	        <td align="center">
			    <button id="btnGuia" type="button" onclick="mostrarGuia('DetalleActividad.pdf')" class="btnH25W95" runat="server" hidefocus="hidefocus" 
				     onmouseover="se(this, 25);mostrarCursor(this);">
...
<input type="hidden" name="hdnIDActividad" id="hdnIDActividad" value="<%=nIdActividad %>" />
