...
function objRecurso(opcionBD, idActividad, idRecurso, nombre, fip, ffe, idTarifa, estado, indicaciones, bNotifExceso){
...
function insertarRecursoEnArray(opcionBD, idActividad, idRecurso, nombre, fip, ffe, idTarifa, estado, indicaciones, bNotifExceso){
    try{
        oRec = new objRecurso(opcionBD, idActividad, idRecurso, nombre, fip, ffe, idTarifa, estado, indicaciones, bNotifExceso);
