...
<body onload="init()" onunload="salir()">
            ...
            <eo:TabStrip runat="server" id="tsPestanas" ControlSkinID="None" Width="980px" MultiPageID="mpContenido" ClientSideOnLoad="CrearPestanas">
	            <TopGroup OverlapDepth="0" Style-CssClass="TabStrip">
		            <Items>
				            ...
				            <eo:TabItem Text-Html="Tareas" ToolTip="" Width="120"></eo:TabItem>
            ...
            <eo:MultiPage runat="server" id="mpContenido" CssClass="FMP" Width="980px" Height="560px">
                                ...
                                <table align="center" border="0" class="texto" width="100%" cellpadding="5" cellspacing="0">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;Finalización
                                            <asp:TextBox ID="txtValFin" runat="server" style="width:60px; cursor:pointer; margin-left:10px;" Calendar="oCal" onchange="activarGrabar();focoAvance();" ></asp:TextBox>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Avance
		                                ...
		                                <tr>
			                                <td >
		                                        <table id="tblTitulo" style="height:17px; width:390px;">
			                                        <tr class="TBLINI">
				                                        <td>&nbsp;Profesionales&nbsp;
								                            <img id="imgLupa1" style="display: none; cursor: pointer" onclick="buscarSiguiente('tblOpciones',0,'divCatalogo','imgLupa1', event)"
		                                        ...
		                                        <table id="tblTitulo2" style="height:17px; width:435px;" >
			                                        <tr class="TBLINI">
				                                        <td width="80%">&nbsp;Asignados&nbsp;
								                            <img id="imgLupa2" style="display: none; cursor:pointer" onclick="buscarSiguiente('tblOpciones2',1,'divCatalogo2','imgLupa2', event)"
									                            height="11" src="../../../../../Images/imgLupaMas.gif" width="20" tipolupa="2" />
							                                <img id="imgLupa4" style="display: none; cursor:pointer" onclick="buscarDescripcion('tblOpciones2',1,'divCatalogo2','imgLupa2', event)"
									                            height="11" src="../../../../../Images/imgLupa.gif" width="20" tipolupa="1" /> 
						                                </td>
                ...
                <table style="width:950px;  margin-left:15px;">
		            <tr>
	                    <td>
                            <table style="width: 920px; height: 17px" >
                                <colgroup>
                                    <col style="width:50px;"/><col style="width:370px;"/><col style="width:75px;"/><col style="width:75px;"/>
                                    <col style="width:75px;"/><col style="width:75px;"/><col style="width:75px;"/><col style="width:75px;"/>
                                    <col style="width:50px;"/>
                                </colgroup>
                                <tr class="TBLINI">
		                            <td style="text-align:right;">Número</td>
		                            <td style="padding-left:5px;">Denominación</td>
		                            <td style="text-align:right;" title='Esfuerzo total planificado'>ETPL</td>
		                            <td title='Fecha inicio planificada' style="padding-left:5px;">FIPL</td>
		                            <td title='Fecha fin planificada'>FFPL</td>
		                            <td title='Esfuerzo total previsto' style="text-align:right;">ETPR</td>
		                            <td title='Fecha fin prevista' style="padding-left:5px;">FFPR</td>
		                            <td title='Consumo en horas' style="text-align:right;">Consumo</td>
		                            <td title='% Avance' style="text-align:right; padding-right:5px;">%Avan.</td>
                                </tr>
                            </table>
                            <div id="divTareas" style="overflow: auto; width: 936px; height:440px" runat="server">
		                        <div id="divH" style='background-image:url(../../../../../Images/imgFT16.gif); width:920px;' runat="server">
		                        </div>
                            </div>
                            <table style="width: 920px; height: 17px">
                                <tr class="TBLFIN">
                    ...
                    <tr>
                        <td>
		                    <center>
		                    <button id="btnAddTarea" type="button" onclick="tareas();" class="btnH25W90" runat="server" hidefocus="hidefocus" 
			                     onmouseover="se(this, 25);mostrarCursor(this);" style="display:inline;">
			                    <img src="../../../../../images/botones/imgAnadir.gif" /><span>&nbsp;Añadir</span>
		                    </button>
		                    <button id="btnDelTarea" type="button" onclick="borrarTareas();" class="btnH25W90" runat="server" hidefocus="hidefocus" 
...
<asp:TextBox ID="hdnDesPE" name="hdnDesPE" runat="server" style="visibility:hidden" Text=""></asp:TextBox>
