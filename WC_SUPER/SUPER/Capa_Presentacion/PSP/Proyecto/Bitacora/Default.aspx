...
<body onload="init()" onunload="unload()" style="margin-left:15px; margin-top:10px;">
...
<table id="tblCab" style="width:980px; text-align:left;">
    ...
    <tr>
        <td>
            <label id="lblProy" style="width:55px; height:16px; margin-top:3px;" class="enlace" onclick="obtenerProyectos()">Proyecto</label>
        </td>
...
<table style="width: 975px; margin-top:5px;">
    <colgroup><col style="width:630px;" /><col style="width:350px" /></colgroup>
    <tr>
        <td colspan="2">
            ...
            <legend>Asunto</legend>
                <table style="width:100%; margin-top:5px;">
                    <tr>
                        <td style="text-align:left;">
                            <label id="Label1" class="texto" style="width:30px;">Tipo</label>
                    ...
                    <tr>
                        <td>
                            <table id="Table1" style="width: 940px; height: 17px; margin-top:8px; text-align:left;">
	                            ...
	                            <tr class="TBLINI">
		                            <td style="padding-left:3px;">
					                    ...
					                    <img id="imgLupa4" style="height:11px; display:none; cursor: pointer" onclick="buscarDescripcion('tblDatos1',0,'divAsunto','imgLupa1', event);" src="../../../../Images/imgLupa.gif" width="20" tipolupa="1" />
					                </td>
		                            <td>
                            ...
                            <div id="divAsunto" style="overflow:auto; overflow-x:hidden; width: 956px; height:200px">
                                <div id="divAsto" style='background-image:url(../../../../Images/imgFT16.gif); width:940px;'>
                                    <%=strTablaHtmlAsunto %>
                                </div>
                            </div>
                    ...
                    <tr>
                        <td>
                            <table style="width:330px; margin-left:300px;">
                                <tr>
                                    <td>
                                        ...
                                        <button id="btnBAs" type="button" onclick="eliminarAsunto()" class="btnH25W90" style="margin-left:60px; display:inline;" runat="server" hidefocus="hidefocus" onmouseover="se(this, 25);mostrarCursor(this);">
    ...
    <tr>
        <td>
            <fieldset style="width:620px; height:220px;">
        ...
        <td>
            ...
            <legend>Bitácora de proyectos técnicos</legend>
            <table style="width:100%;">
                <tr>
                    <td>
	                    <table id="tblTitulo" style="width:305px; height:17px" >
		                    <tr class="TBLINI">
			                    <td style="text-align:left;">&nbsp;Denominación&nbsp;
				                    <img id="img2" style="display: none; cursor: pointer" onclick="buscarSiguiente('tblPTs',0,'divPTs','img2', event)" 
				                        height="11" src="../../../../Images/imgLupaMas.gif" width="20" tipolupa="2" />
			                        <img id="imgLupa6" style="display: none; cursor: pointer" onclick="buscarDescripcion('tblPTs',0,'divPTs','img2', event)" 
			                            height="11" src="../../../../Images/imgLupa.gif" width="20" tipolupa="1" /> 
			                    </td>
		                    </tr>
	                    </table>
...
<input type="hidden" runat="server" name="hdnAcceso" id="hdnAcceso" value="E" />
