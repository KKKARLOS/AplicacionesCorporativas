...
<table style="width:420px; margin-left:20px;">
	<tr>
		<td>
			<table id="tblTitulo" style="width:400px; height:17px;" >
				...
				<tr class="TBLINI">
					...
					<td style="padding-left:5px;">&nbsp;Denominación&nbsp;
						<img id="imgLupa1" style="display: none; cursor: pointer" onclick="buscarSiguiente('tblDatos',1,'divCatalogo','imgLupa1', event)"
			...
			<div id="divCatalogo" style="overflow:auto; overflow-x:hidden; width:416px; height: 336px">
