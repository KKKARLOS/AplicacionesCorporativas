...
public partial class obtenerPT : System.Web.UI.Page, ICallbackEventHandler
    {
        ...
        private string ObtenerPTs(string sTipoBusqueda, string sPSN, string strNomPT)
        {
            ...
            try
            {
                ...
                if (sPSN != "")
                    nPSN = int.Parse(sPSN);
                strBuilder.Append("<div style='background-image:url(../../../../Images/imgFT16.gif); width:396px;'>");
                ...
                while (dr.Read())
                {
                    ...
                    strBuilder.Append("' sAccBitacora='" + dr["t305_accesobitacora_pst"].ToString());
                    strBuilder.Append("' onclick='ms(this)' ondblclick='aceptarClick(this.rowIndex)' style='height:16px;'>");
