<%@ Page Language="c#" CodeFile="obtenerTarea2.aspx.cs" Inherits="obtenerTarea2" %>
...
<base target="_self" />
	...
	<!--
        ...
        function buscarTareas(strValor){
            try{
                if (strValor == ""){
                    mmoff("Inf","Debes indicar la denominación a buscar.",330);
                    return;
                }
                var js_args = "T@#@";
                ...
                js_args += sAccion + "@#@";
                js_args += Utilidades.escape($I("txtTarea").value)+ "@#@";
        ...
        function estructura(oFila){
            try{
		        ...
		        mostrarErrorAplicacion("Error al buscar las tareas (estructura)", e.message);
            }
		}
        /*
...
<tr>
    <td>
	    ...
	    <tr><td>Denominación tarea
            <asp:TextBox ID="txtTarea" runat="server" Width="343px" onKeyPress="javascript:if(event.keyCode==13){buscarTareas(this.value);event.keyCode=0;}"></asp:TextBox><br /><br />
            </td>
        </tr>
        <tr>
            <td>			    
        ...
        <tr>
            <td>
	            <div id="divCatalogo" style="overflow-x: hidden; overflow-y: auto;width: 456px; height:300px">
...
<!--
	...
	function aceptarClick(indexFila){
	    ...
	    strDatos = tblDatos.rows[indexFila].id + "@#@" + tblDatos.rows[indexFila].innerText + "@#@" + tblDatos.rows[indexFila].getAttribute("nPE") + "@#@" + tblDatos.rows[indexFila].getAttribute("sPE") + "@#@" + tblDatos.rows[indexFila].getAttribute("nPT") + "@#@" + tblDatos.rows[indexFila].getAttribute("sPT") + "@#@" + tblDatos.rows[indexFila].getAttribute("nF") + "@#@" + tblDatos.rows[indexFila].getAttribute("sF") + "@#@" + tblDatos.rows[indexFila].getAttribute("nA") + "@#@" + tblDatos.rows[indexFila].getAttribute("sA") + "@#@" + tblDatos.rows[iFila].getAttribute("sT305IdPr") + "@#@" + tblDatos.rows[iFila].getAttribute("sEst");
