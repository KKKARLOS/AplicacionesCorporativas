<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_PSP_Conceptos_Respon_Default" %>
...
<HEAD runat="server">
	<title> ::: SUPER ::: - Selección de responsables de proyecto</title>
        ...
        <tr>
            <td><!-- Relación de Items -->
                ...
                <div id="divCatalogo" style="overflow: auto; overflow-x: hidden; width: 366px; height:300px">
                    ...
                    <table id="tblDatos" style="width: 350px;" class="texto">
                    </table>
                    </div>
                </div>
