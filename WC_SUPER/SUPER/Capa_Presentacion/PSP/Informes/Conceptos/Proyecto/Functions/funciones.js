...
//                    mmoff("La selección realizada excede un límite razonable. Por favor, acote más su consulta.", 500, 2500);
//                }else{
...
function aceptar(){
    try{
        ...
        for (var i=0; i<$I("tblDatos2").rows.length;i++){
            ...
            //Datos añadidos para las pantallas de consultas multivalor
