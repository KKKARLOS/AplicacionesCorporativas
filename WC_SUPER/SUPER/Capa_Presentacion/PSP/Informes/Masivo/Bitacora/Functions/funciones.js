    ...
    if (aResul[1] != "OK") {
        ...
        switch (aResul[0]) {
            ...
            case "getExcel":
                ...
                break;
//            case "setPreferencia":
//                if (aResul[2] != "0") mmoff("Preferencia almacenada con referencia: " + aResul[2].ToString("N", 9, 0), 300, 3000);
//                else mmoff("La preferencia a almacenar ya se encuentra registrada.", 350, 3000);
//                break;
//            case "delPreferencia":
//                mmoff("Preferencias eliminadas.", 250);
//                break;
//            case "getPreferencia":
    ...
    try {
        ...
        if ($I('txtFechaInicio').value != "" && $I('txtFechaFin').value != "") {
            ...
            if (fecha_desde > fecha_hasta) {
                mmoff("Inf", "Rango de fechas incorrecto.", 200);
                return false;
            }
        }
        ...
        //var js_args = "getExcel@#@" + $I('txtFechaInicio').value + "@#@" + $I('txtFechaFin').value + "@#@" + strCadena;
        var js_args = "getExcel@#@" + strCadena;
        mostrarProcesando();
