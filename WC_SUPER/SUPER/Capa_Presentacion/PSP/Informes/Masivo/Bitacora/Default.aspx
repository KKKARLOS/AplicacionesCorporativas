...
<div id="divPestRetr" style="position:absolute; left:20px; top:98px; width:960px; height:380px; clip:rect(auto auto 0 auto)">
    <table style="width:960px;" cellpadding="0" cellspacing="0" border="0">
    <tr style="vertical-align:top;">
        <td>
            <table style="width:945px; height:380px;" cellpadding="0" cellspacing="0" border="0">
                <tr>
		            <td background="../../../../../Images/Tabla/4.gif" width="6px">&nbsp;</td>
                        ...
                        <tr>
                            <td>
                                <fieldset style="width: 290px; height:50px;">
                                    ...
                                    <div id="divProyecto" style="overflow:auto; width: 276px; height:36px; margin-top:2px">
                                        <div style="background-image:url('<%=Session["strServer"] %>Images/imgFT18.gif'); width:260px;">
...
<table id="tblGeneral" width="100%" style="margin-left:10px; margin-top:10px; width:990px;">
    ...
    <tr>
    	<td style="padding-right:20px;padding-bottom:5px; text-align:right;">
		...
		<td style="padding-right:20px;padding-bottom:5px; vertical-align:bottom; text-align:right;">
    ...
    <tr>
        <td><!-- Relación de Items -->
            <table id="tblTitulo" style="width:450px; height:17px">
                <colgroup><col style="width:105px;"/><col style="width:345px;"/></colgroup>
                <tr class="TBLINI">
...
<asp:TextBox ID="hdnHasta" style="visibility:hidden" Text="" readonly="true" runat="server" />
 <fieldset id="fldPeriodo" style="visibility:hidden;" runat="server">
 <legend title="Periodo temporal">&nbsp;Periodo&nbsp;</legend>
    <table>
        <tr>
            <td>
                <asp:TextBox ID="txtFechaInicio" runat="server" Text="" Calendar="oCal" onchange="VerFecha('D');" goma=0 />
                <asp:TextBox ID="txtFechaFin" runat="server" Text="" Calendar="oCal" onchange="VerFecha('H');" goma=0 />
            </td>
        </tr>
    </table>
</fieldset>	 
