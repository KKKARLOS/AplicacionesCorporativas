...
<colgroup>
    ...
    <tr style="vertical-align: top;">
        ...
        <td>
            ...
            <tr>
                <td style="text-align:center;"><input type="checkbox" tipo="agregado" class="check" codigo="t303_idnodo" valor="t303_denominacion" onclick="setIndicadoresAux();" style="cursor:pointer;" /></td>
                <td></td>
                <td>Nodo</td>
            </tr>
            <tr>
                <td style="text-align:center;"><input type="checkbox" tipo="agregado" class="check" codigo="t301_idproyecto" valor="t301_denominacion" onclick="setIndicadoresAux();" style="cursor:pointer;" /></td>
                <td></td>
                <td>Proyecto</td>
            </tr>
            <tr>
                <td style="text-align:center;"><input type="checkbox" tipo="agregado" class="check" codigo="t302_idcliente" valor="t302_denominacion" onclick="setIndicadoresAux();" style="cursor:pointer;" /></td>
                <td></td>
                <td>Cliente</td>
            </tr>
            <tr>
                <td style="text-align:center;"><input type="checkbox" tipo="agregado" class="check" codigo="t314_idusuario_responsable" valor="ResponsableProyecto" onclick="setIndicadoresAux();" style="cursor:pointer;" /></td>
                <td></td>
                <td>Responsable de proyecto</td>
            </tr>
            <tr>
                <td style="text-align:center;"><input type="checkbox" tipo="agregado" class="check" codigo="t305_cualidad" valor="t305_cualidad" onclick="setIndicadoresAux();" style="cursor:pointer;" /></td>
                <td></td>
                <td>Cualidad</td>
            </tr>
            <tr>
                <td style="text-align:center;"><input type="checkbox" tipo="agregado" class="check" codigo="t323_idnaturaleza" valor="t323_denominacion" onclick="setIndicadoresAux();" style="cursor:pointer;" /></td>
                <td></td>
                <td>Naturaleza</td>
            </tr>
            <tr>
            ...
            <tr>
                <td></td>
                <td style="text-align:center;"><input type="checkbox" tipo="dato" class="check" codigo="Margen" onclick="setIndicadoresAux();" value="Margen" style="cursor:pointer;" /></td>
                <td>Margen</td>
            </tr>
            <tr>
                <td></td>
