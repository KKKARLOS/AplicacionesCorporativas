    ...
    if (aResul[1] != "OK") {
        ...
        switch (aResul[0]) {
            case "obtener":
                ...
                $I("divCatalogo").children[0].style.width = $I("tblDatos").scrollWidth + "px";
                //            }
...
function Obtener() {
    try {
        ...
        sb.Append(getRadioButtonSelectedValue("rdbEvolucion", false) +"@#@");
        ...
        for (var i = 0; i < aInputs.length; i++) {
            ...
            if (aInputs[i].getAttribute("tipo") == "agregado") {
                sAgrupacion += aInputs[i].getAttribute("codigo") + "{sep}";
                sVisualizacion += aInputs[i].getAttribute("valor") + "{sep}";
                sw1 = 1;
            } else {
                sDato += aInputs[i].getAttribute("codigo") + "{sep}";
                sw2 = 1;
            }
        }
        if (sw1 == 0) {
        ...
        sb.Append(sAgrupacion + "@#@");
        sb.Append(sVisualizacion + "@#@");
        sb.Append(sDato + "@#@");
