    ...
    function init() {
        ...
        function mostrarDetalle() {
            ...
            IB.DAL.post(IB.vars.strserver + "Services/Historial.asmx", "Reemplazar", { newUrl: newurl }, null,
                function () {
                    var qs = IB.uri.encode("modo=E&id=" + $(el).attr("data-idaccion") + "&origenpantalla=SUPER&caller=catalogofigareasubarea");
        ...
        function exportarExcel() {
            ...
            IB.Exportaciones.exportarDataTableExcel($("#tblAcciones"), "Acciones", "Consulta de acciones bajo mi ámbito de visión", false);
        }        
    }
