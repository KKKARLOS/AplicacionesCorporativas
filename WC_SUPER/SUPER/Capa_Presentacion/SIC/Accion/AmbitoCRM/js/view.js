...
SUPER.SIC.viewCatAccion = (function () {
    ...
    function init() {
        ...
        //Formato numérico en los filtros de importes
        ...
        dom.divAyudaLideres.buscaprofmulti({
            ...
            searchParams: { proc: "SIC_GET_HLP_LIDERES_PB" },
            autoSearch: true,
            autoShow: false,
        ...
        dom.divAyudaUnidades.ayudamulti({
            ...
            notFound: "No se han encontrado resultados.",
            modulo: "SIC",
            tipoAyuda: "SIC_AYUDA3UNIDADESPREVENTA_CAT",
            autoSearch: true,
            autoShow: false,
            eliminarExistentes: true,
        ...
        dom.divAyudaAreas.ayudamulti({
            ...
            notFound: "No se han encontrado resultados.",
            modulo: "SIC",
            tipoAyuda: "SIC_AYUDA3AREASPREVENTA_CAT",
            autoSearch: true,
            autoShow: false,
            eliminarExistentes: true,
        ...
        dom.divAyudaSubareas.ayudasubareasficepi({
            autoSearch: false,
            autoShow: false,
            tipoAyudaUnidades: "SIC_AYUDA3UNIDADESPREVENTA_CAT",
            tipoAyudaAreas: "SIC_AYUDA3AREASPREVENTA_CAT",
            tipoAyudaSubareas: "SIC_AYUDA3SUBAREASPREVENTA_CAT",
            eliminarExistentes: true,
            onAceptar: function (data) {
                var html = "";
                data.forEach(function (item) {
    ...
    function cmbOrigen_onChange() {
        ...
        switch (cmbOrigenValue) {
            case "O":
                ...
                options.tipoAyuda = "SIC_AYUDA3ITEMORIGEN_O_CAT";
            ...
            case "E":
                ...
                options.tipoAyuda = "SIC_AYUDA3ITEMORIGEN_E_CAT";
            ...
            case "P":
                ...
                options.tipoAyuda = "SIC_AYUDA3ITEMORIGEN_P_CAT";
            ...
            "columnDefs": [
...

                {
                    ...
                    "render": function (data, type, row, meta) {
                        ...
                        s += " " + accounting.formatNumber(row.ta206_iditemorigen, 0, ".") ;
                        if (data === "E")    
                            s += "&nbsp;&nbsp;&nbsp;(nº ON " + accounting.formatNumber(row.numero_oportunidad, 0, ".") + ")";
                        s += "</nobr><br />";
