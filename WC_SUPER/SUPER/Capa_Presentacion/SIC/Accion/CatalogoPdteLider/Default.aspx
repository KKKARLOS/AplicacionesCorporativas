<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_SIC_Accion_CatalogoPdteLider_Default" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                  ...
                  <div class="ibox-title">
                    <h5 class="text-primary inline">Catálogo de acciones pendientes de asignar lider</h5>
                    </div>
                Tipo asignación del líder 
                <select id="cmbTipoAsignacion">
                    <option value="true">El subarea permite autoasignación</option>
                    <option value="false">El responsable del subarea asigna lider</option>
                    <option value="-1" selected>Todas</option>
                </select>
                <div class="ibox-content  blockquote blockquote-info">
                    <div class="table-responsive" style="overflow-y:hidden">
                        <table id="tblAcciones" class="table table-bordered table-condensed" sstyle="width:2000px">
                            <thead class="well text-primary">
                                <tr>
                                    ...
                                    <th class="text-center">Tipo asignacion</th>                                                                                                                                                                                    
                                </tr>
                            </thead>
                        </table>
