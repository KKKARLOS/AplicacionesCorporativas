...
(function ($) {
    ...
    function Plugin(element, options) {
                             ...
                             "<div id='" + pluginName + "-divProfesionales'>" +
                                 "<div class='row'>" +
                                    ...
                                    "<div class='fk_filters'>" +
                                        "<div class='col-xs-12'>" +
                                            "<input id='" + pluginName + "-txtFiltro' type='text' class='col-xs-12' placeholder='" + options.placeholderText + "' />" +
                                        "</div>" +
                                    "</div>" +
        ...
        function search() {
            ...
            var filtro = options.autoSearch ? options.filtro : $el.find("#" + pluginName + "-txtFiltro").val();
            if (filtro.length == 0 && !options.autoSearch) return;

            var n = window.setTimeout(function () { $el.find("#" + pluginName + "-listcontent").html("Buscando ...") }, 500)

            var payload = {
                tipo: options.tipoAyuda,
                filtro: filtro
            }
