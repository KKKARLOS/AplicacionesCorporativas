...
(function ($) {
    ...
    function Plugin(element, options) {
        ...
        function search() {
            ...
            var serviceUrl = IB.vars.strserver + "Capa_Presentacion/" + options.modulo + "/Services/Profesionales.asmx";

            IB.DAL.post(serviceUrl, options.tipoAyuda, payload, null,
                function (data) {
