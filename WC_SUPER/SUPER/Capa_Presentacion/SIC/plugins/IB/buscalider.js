...
(function ($) {
    ...
    function Plugin(element, _options) {
        ...
        function initModal() {
                        ...
                        "<div class='modal-dialog' role='dialog'>" +
                            "<div class='modal-content'>" +
                                ...
                                "<div class='modal-body'>" +
                                    "<div class='row fk_radio_extensibleSearch'>" +
                                        "<div class='col-xs-12'>" +
                                            "<div class='formgroup'><input type='radio' name='rdoSearchExtend' value='0'> Mostrar posibles líderes del subárea.</div>" +
                                            "<div class='formgroup'><input type='radio' name='rdoSearchExtend' value='1'> Elegir cualquier profesional de la Organización.</div>" +
                                        "</div>" +
                                    "</div><br />" +
            ...
            $el.find(".fk_radio_extensibleSearch").find("input[name='rdoSearchExtend']").on("change", function () {
        ...
        function showModal() {
            ...
            $el.find("#" + pluginName + "-listcontent").empty();
            $el.find("#" + pluginName + "-searchInListContainer").removeClass("show").addClass("hide");

            if (_options.extensibleSearch) {
                $el.find(".fk_radio_extensibleSearch").removeClass("hide");
                $el.find(".fk_radio_extensibleSearch").find("input[value='0']").prop("checked", true);
            }
            else {
                $el.find(".fk_radio_extensibleSearch").addClass("hide");
            }
        ...
        function changeTypeSearch(type) { //0:posibles lideres del subarea; 1:todos los profesionales

            $el.find("#" + pluginName + "-listcontent").empty();

            //ocultar los campos de criterio de filtrado
            if (type == 0) {
                _options.tipoAyuda = "lideressubarea";
                _options.autoSearch = true;
                $el.find(".fk_filters").addClass("hide");
                search();
            }
            else { //dar el foco al primer campo del filtrado
                _options.tipoAyuda = "GeneralFicepi";
                _options.autoSearch = false;
