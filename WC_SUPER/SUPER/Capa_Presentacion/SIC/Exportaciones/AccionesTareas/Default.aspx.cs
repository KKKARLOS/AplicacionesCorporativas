...
public partial class Capa_Presentacion_SIC_Exportaciones_AccionesTareas_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Shared.LogError.LogearError("Error al cargar la pantalla de exportación de acciones y tareas", ex);
