...
public partial class Capa_Presentacion_SIC_Exportaciones_ExportarExcelDatatableCliente : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            myArray = IB.SUPER.SIC.Utilidades.Exportaciones.exportarExcel(schema, datos, sFilename, stituloExcel);
