<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Plantilla.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_CVT_EntornoTecno_Default" %>
...
<div id="principal" style="width:390px; margin-top:15px; text-align:left;">
    <table id="tblTitulo" style="width:370px; height:17px;">
        <colgroup>
    ...
    <div id="divCatalogo" style="overflow-x:hidden; overflow-y:auto; WIDTH: 386px; height:400px;" runat="server"  name="divCatalogo"  onscroll="scrollTabla()">
        <div style="background-image:url('../../../../Images/imgFT22.gif'); background-repeat:repeat; width:370px; height:auto;">
                <%=strTablaHTML%>
        </div>
    </div>
    <table id="tblResultado" style="width:370px; height:17px;">
        <tr class="TBLFIN">
            <td>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="center">
                <button id="btnReasignar" type="button" onclick="reasignar();" class="btnH25W95" runat="server" hidefocus="hidefocus" 
	                 onmouseover="se(this, 25);mostrarCursor(this);">
	                <img src="../../../../Images/botones/imgReasignar.gif" /><span title="Permite reasignar los profesionales asociados a un entorno tecnológico a otro entorno tecnológico">Reasignar</span>
                </button>
            </td>
        </tr>
    </table>
