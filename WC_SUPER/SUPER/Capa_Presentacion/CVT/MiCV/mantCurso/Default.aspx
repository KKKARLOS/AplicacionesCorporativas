<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_CVT_MiCV_mantCurso_Default" EnableEventValidation="false" ValidateRequest="false" %>
...
<fieldset id="fstDatosCurso" style="width:440px; height:200px; margin-left:10px; margin-top:5px;">
    ...
    <tr>
        ...
        <td>
            ...
            <fieldset style="">  
                ...
                <input id="rdbComp" type="radio" name="rdbTecnComp" runat="server" value="1" style="margin-left:18px; vertical-align:middle;"/>Competencias
                </div>
            </fieldset>  
        </td>
    </tr>
    ...
    <tr>
        <td>
            <label id="lblEntorno">Entorno</label><asp:Label ID="Label1" runat="server" ForeColor="Red" style="margin-left:3px;">*</asp:Label>
        </td>
        <td colspan="2">
...
<fieldset id="fstObtencion" style="width:440px; height:90px; margin-left:10px; margin-top:10px;">
    <legend>Obtención del curso</legend>
    <table id="Table2" style="width:440px; margin-top:5px;" cellspacing="3" cellpadding="3" border="0">
        ...
        <tr>
            <td>
                <label id="lblProveedor" class="label">Centro formativo</label>
                <asp:Label ID="Label10" runat="server" ForeColor="Red">*</asp:Label>
            </td>
            <td>
                <input name="q" id="query" class="txtM" runat="server" style="width:302px; margin-left:1px;" maxlength="50" watermarktext="Ej: MICROSOFT IBERICA,S.R.L." value="" />
                <img src="../../../../Images/imgSugerencia.png" style="vertical-align:middle; margin-left:3px;" title="En función del texto introducido, el sistema le sugerirá proveedores existentes" />
            </td>
        </tr>
    </table>
    </fieldset>
<fieldset id="fstAdjuntos" style="width:440px; height:45px; margin-left:10px; margin-top:10px;">
    ...
    <tr>
        <td>
            <label title="Documentación acreditativa del curso">Documento</label><asp:Label ID="Label9" runat="server" ForeColor="Red" style="margin-left:3px">*</asp:Label>
        </td>
        <td>
            <asp:TextBox ID="txtNombreDocumento" runat="server" style="width:260px;" ReadOnly="true" Text="" />
...
<table id="Table4" style="width:440px; margin-top:5px; margin-left:10px;" cellspacing="3" cellpadding="3" border="0">
    <tr>
        <td valign="top">
            ...
            <asp:TextBox Wrap="true" TextMode="MultiLine" id="txtObservaciones" style="width:440px; height:60px; resize:none;"  runat="server" ></asp:TextBox>
        </td>
    </tr>
</table>
<center>
...
<div id="divFondoMotivo" style="z-index:10; position:absolute; left:0px; top:0px; width:600px; height:600px; background-image: url(../../../../Images/imgFondoOscurecido.png); background-repeat:repeat; visibility:hidden;" runat="server">
    ...
    <input type="hidden" id="hdnIdCurso"  runat="server" value="-1"/>
