		...
		<td>
			...
			<eo:MultiPage runat="server" id="mpContenido" CssClass="FMP" Width="100%" Height="340px">
                ...
                <tr class="TBLINIGASTO" style="height:18px; vertical-align:bottom;"> 
                  ...
                  <td style="border-top:solid 1px #e9e9e9;border-right:solid 1px #e9e9e9;" colspan="3"><img id="imgKMSEstandares" src="../../../Images/imgSeparador.gif" style="width:16px; height:16px;" border="0" /><span style="width:auto; text-align:center; vertical-align: top; margin-left:7px">Vehículo propio</span></td>
                </tr>
                <tr class="TBLINIGASTO" align="center">
                  ...
                  <td style="border-top:solid 1px #e9e9e9;border-right:solid 1px #e9e9e9;" id="cldDC"><nobr style="noWrap:true;cursor:pointer;" class="TooltipGasto" title="cssbody=[dvbdy] cssheader=[dvhdr] header=[<img src='../../../images/info.gif' style='vertical-align:middle' />  Nº de dietas completas] body=[La dieta incluye todos los gastos que se produzcan en el día, ocasionados por el viaje, a excepción de desplazamientos, hoteles y aparcamiento.<br><br>La cuantía diaria que satisfará la Empresa y que no requerirá la entrega de ningún justificante es de 38,17 €.<br><br>Se podrá aplicar en los siguientes tipos de desplazamiento:<br>Con pernocta<br>Sin pernocta y lejos (distancias superiores a 50 kilómetros), en desplazamientos esporádicos (duración inferior a dos semanas)<br>(Como alternativa, en aquellas circunstancias por las que se pueda justificar razonablemente, la Empresa abonará los gastos correspondientes, con un límite de 18,03 € por comida)<br><br>Art.12 del Convenio.] hideselects=[off]">C</nobr></td>
                  <td style="border-top:solid 1px #e9e9e9;border-right:solid 1px #e9e9e9;" id="cldDM"><nobr style="noWrap:true;cursor:pointer;" class="TooltipGasto" title="cssbody=[dvbdy] cssheader=[dvhdr] header=[<img src='../../../images/info.gif' style='vertical-align:middle' />  Nº de medias dietas] body=[La media dieta incluye los mismos conceptos que la dieta, pero se aplica cuando no se realiza la comida o la cena.<br><br>La cuantía diaria que satisfará la Empresa y que no requerirá la entrega de ningún justificante es de 21,47 €.<br><br>Se podrá aplicar en los siguientes tipos de desplazamiento:<br>Con pernocta<br>Sin pernocta y lejos (distancias superiores a 50 kilómetros), en desplazamientos esporádicos (duración inferior a dos semanas)<br>(Como alternativa, en aquellas circunstancias por las que se pueda justificar razonablemente, la Empresa abonará los gastos correspondientes, con un límite de 18,03 € por comida)<br><br>Art.12 del Convenio.] hideselects=[off]">M</nobr></td>
                  <td style="border-top:solid 1px #e9e9e9;border-right:solid 1px #e9e9e9;" id="cldDA"><nobr style="noWrap:true;cursor:pointer;" class="TooltipGasto" title="cssbody=[dvbdy] cssheader=[dvhdr] header=[<img src='../../../images/info.gif' style='vertical-align:middle' />  Nº de dietas especiales] body=[La cuantía que satisfará la Empresa, y que no requerirá la entrega de ningún justificante, es de 10,00 €.<br><br>Se podrá aplicar en los siguientes tipos de desplazamiento:<br>Sin pernocta y lejos (distancias superiores a 50 kilómetros) en desplazamientos continuados (duración superior a dos semanas)<br>Sin pernocta y cerca.<br>(Como alternativa, la empresa abonará los gastos pagados correspondientes al menú del día)<br><br>Art.12 del Convenio.] hideselects=[off]">E</nobr></td>
                  <td style="border-top:solid 1px #e9e9e9;border-right:solid 1px #e9e9e9;" id="cldDE"><nobr style="noWrap:true;cursor:pointer;" class="TooltipGasto" title="cssbody=[dvbdy] cssheader=[dvhdr] header=[<img src='../../../images/info.gif' style='vertical-align:middle' />  Nº de dietas de alojamiento] body=[En el caso de que el empleado decidiese alojarse por su cuenta, IBERMÁTICA le abonará por ese concepto un importe equivalente al 75% del precio de la dieta por cada día que permanezca en dicha situación.<br><br>Art.12 del Convenio.] hideselects=[off]">A</nobr></td>
                        ...
                        <tr>
                            ...
                            <td background="../../../Images/Tabla/5.gif" style="padding: 5px; vertical-align:top;">
				                ...
				                <tr class="TBLINIGASTO">
				                    ...
				                    <td style="border-right:solid 1px #e9e9e9;">Exento de retención</td>
				                </tr>
				                <tr class="FA">
				...
				<tr>
                    ...
                    color:#5894ae;">Datos para contabilización</div>
