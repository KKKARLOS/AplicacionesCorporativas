...
public partial class Default : System.Web.UI.Page
    {
        ...
        override protected void OnInit(EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    rdFormulario.Load(Server.MapPath(".") + @"\MultiProyecto.rpt");
                }
                catch (Exception ex)
                {
                    rdFormulario.Close();
                ...
                rdFormulario.SetParameterValue("@t420_idreferencia", int.Parse(Request.Form[pf + "hdnReferencia"].ToString()));
                //rdFormulario.SetParameterValue("@t420_idreferencia", "77");
