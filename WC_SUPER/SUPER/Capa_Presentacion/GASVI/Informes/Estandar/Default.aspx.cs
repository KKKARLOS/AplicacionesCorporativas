...
//                string pf = "ctl00$CPHC$";
                ...
                string strconexion = SUPER.Capa_Negocio.Utilidades.CadenaConexion;
                ...
                try
                {
                    rdFormulario.Load(Server.MapPath(".") + @"\Estandar.rpt");
                }
                catch (Exception ex)
                {
                    rdFormulario.Close();
                ...
                rdFormulario.SetParameterValue("@sReferencia", SUPER.Capa_Negocio.Utilidades.decodpar(Request.QueryString["ref"].ToString()));
                //rdFormulario.SetParameterValue("@sReferencia", Request.QueryString["ref"].ToString());
