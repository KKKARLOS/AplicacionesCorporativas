<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getSubnodo.aspx.cs" Inherits="Capa_Presentacion_ECO_getSubnodo" %>
...
<base target="_self" />
    <title> ::: SUPER ::: - Selección de <%=Estructura.getDefCorta(Estructura.sTipoElem.SUBNODO) %> </title>
