<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getResponsable.aspx.cs" Inherits="getResponsable" %>
...
<head runat="server">
    ...
    function init(){
        try{
            ...
            if (tiporeplica != "P" ) $I("txtApellido1").focus();
            ocultarProcesando();
        }catch(e){
    ...
    function aceptarClick(indexFila){
	    try{
            ...
            var strDatos = $I("tblDatos").rows[indexFila].id + "@#@" + sTexto + "@#@" + $I("tblDatos").rows[indexFila].getAttribute("idficepi");
...
<ucproc:Procesando ID="Procesando" runat="server" />
    ...
    <table class="texto" style="margin-left:10px; width:520px;" cellpadding="5">
	    <tr>
	        <td width="410px">
                        <table id="tblApellidos" style="WIDTH: 390px;margin-bottom:5px;">
                        <colgroup>
        ...
        <tr>
            <td colspan="2">
                ...
                <DIV id="divCatalogo" style="OVERFLOW: auto; WIDTH: 516px; height:345px">
