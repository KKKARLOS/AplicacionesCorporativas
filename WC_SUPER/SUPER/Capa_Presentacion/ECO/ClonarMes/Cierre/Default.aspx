...
<table style="width:970px; margin-left:3px;" cellpadding="5px">
    ...
    <tr style="height:70px;">
        ...
        <td><div id="divMsgR" class="texto" style="display:none;color:Navy; font-weight:bold;">Se han detectado circunstancias que impiden realizar el cierre.</div>
	        ...
	        <div id="divMsgV" class="texto" style="display:none;color:Navy; font-weight:bold;">Para ejecutar el cierre, pulsa el botón " Procesar".</div>
...
<TABLE id="tabla" style="width:990px">
	<TR>
		<TD width="720px">
            ...
            <DIV id="divCatalogo" style="overflow:auto; overflow-x:hidden; width: 986px; height:420px" runat="server">
    ...
    <tr><td>
            ...
            <img class="ICO" style="margin-left:15px;" src="../../../Images/imgIconoObl16Azul.gif" title="Cierre no permitido. Existen cualificadores de proyecto departamentales obligatorios sin cumplimentar." />Cualificadores
            <img class="ICO" style="margin-left:15px;" src="../../../Images/imgConsNivel.gif" />Con consumos por nivel
            <img class="ICO" style="margin-left:15px;" src="../../../Images/imgAjuste2.gif" />Ajuste automático
            <img class="ICO" style="margin-left:15px;" src="../../../Images/imgConsumoPeriod.gif" title="Consumos periodificados" />Cons. periodificados
            <img class="ICO" style="margin-left:15px;" src="../../../Images/imgProduccionPeriod.gif" title="Producción periodificada" />Prod. periodificada
            <img class="ICO" style="margin-left:15px;" src="../../../Images/imgExclamacion.png" title="Conflicto de integridad monetaria entre el contrato y los proyectos asociados al mismo" />Conflicto entre monedas
    </td></tr>
</TABLE>
