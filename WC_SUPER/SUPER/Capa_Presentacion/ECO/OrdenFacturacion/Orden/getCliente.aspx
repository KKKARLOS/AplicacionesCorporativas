...
<ucproc:Procesando ID="Procesando" runat="server" />
	...
	<script type="text/javascript">
		...
		<fieldset style="margin-left:17px; width:540px; height:45px;text-align:left">
		    <legend>Búsqueda por denominación, código SAP o CIF</legend>
		    <table>
			    <tr>
                    ...
                    <td>
                    <asp:RadioButtonList ID="rdbTipo" SkinId="rbli" runat="server" RepeatColumns="2" ToolTip="Tipo de búsqueda" onclick="buscarClientes($I('txtCliente').value);">
