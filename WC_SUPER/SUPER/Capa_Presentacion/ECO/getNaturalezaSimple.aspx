<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getNaturalezaSimple.aspx.cs" Inherits="getNaturalezaSimple" %>
...
<base target="_self" />
    <title> ::: SUPER ::: - Selección de Naturaleza </title>
                ...
                <table id="tblTitulo" style="width: 350px; height: 17px" >
                    <tr class="TBLINI">
                        <td style="padding-left:3px;">Denominación&nbsp;<img id="imgLupa" style="display: none; cursor: pointer" onclick="buscarSiguiente('tblDatos',0,'divCatalogo','imgLupa')"
				            height="11" src="../../Images/imgLupaMas.gif" width="20" tipolupa="2" alt=""/> <img style="cursor: pointer; display: none;" onclick="buscarDescripcion('tblDatos',0,'divCatalogo','imgLupa',event)"
				            height="11" src="../../Images/imgLupa.gif" width="20" tipolupa="1" alt=""/>
				        </td>
                    </tr>
                </table>
