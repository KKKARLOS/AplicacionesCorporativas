...
<head runat="server">
    <title> ::: SUPER ::: - Consumo por periodificación</title>
...
<div id="divMonedaImportes" runat="server" style="position:absolute; top:5px; left:10px; width:300px; visibility:hidden;">
	...
	<script type="text/javascript">
        ...
        <table cellpadding="3" style="width: 520px; margin-top:65px; text-align:left">
            <colgroup>
        ...
        <center>
        <table id="tblBotones" align="center" style="margin-top:20px;" width="90%">
            <tr>
                <td align="center">
