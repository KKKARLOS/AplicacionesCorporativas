...
function init(){
    try {
        $I("ctl00_SiteMapPath1").innerHTML = "&gt; PGE &gt; Mantenimientos &gt; Perfiles por " + $I("lblNodo").innerText.toLowerCase();
    ...
    if (aResul[1] != "OK"){
        ...
        switch (aResul[0]){
            ...
            case "getTarifas":
                ...
                //tbody.attachEvent('onmousedown', startDragIMG);
...
function LLamadaSetNodo(oNodo) {
    try {
        ...
        $I("lblMoneda").innerText = oNodo.options[oNodo.selectedIndex].getAttribute("desmoneda");
        getTarifas();
    }
    catch (e) {
