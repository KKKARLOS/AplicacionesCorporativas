<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getComercial.aspx.cs" Inherits="Capa_Presentacion_ECO_getComercial" %>
...
<head runat="server">
	<title> ::: SUPER ::: - Selección de comerciales</title>
    ...
    function mostrarProfesionales(){
        try{
            ...
            mostrarErrorAplicacion("Error al obtener la relación de comerciales", e.message);
        }
    }
    ...
    function scrollTablaProf() {
        try {
            ...
            mostrarErrorAplicacion("Error al controlar el scroll de comerciales.", e.message);
        }
    }
    </script>
</head>
...
<ucproc:Procesando ID="Procesando" runat="server" />
    ...
    <center>
	<table style="margin-top:10px; width:510px; text-align:left;">
		<tbody>
		    <tr>
		        <td>
                    <table id="tblApellidos" style="width:500px; margin-bottom:5px; text-align:left;">
                    <colgroup>
                    ...
                    <col style="width:125px"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="chkBajas" hidefocus class="check" type="checkbox" runat="server"  
                                    onclick="javascript:mostrarProfesionales();">&nbsp;Mostrar bajas
                            </td>
                        </tr>
                    </table>
		        </td>
			...
			<tr>
				<td>
					<table id="tblTitulo" style="height:17px;width:490px">
						<tr class="TBLINI">
							<td>&nbsp;Comercial&nbsp;
					...
					<div id="divCatalogo" style="overflow:auto; overflow-x:hidden; width:506px; height:378px" onscroll="scrollTablaProf();">
                        <div style='background-image:url(../../Images/imgFT18.gif); width:490px;'>
						</div>
	                </div>
                    <table style="height:17px;width:490px">
                        <tr class="TBLFIN">
                            <td></td>
                        </tr>
                    </table>
