...
dragTable.prototype.drop = function(dragObj, e) {
    ...
    if (typeof (e.targElm.cellIndex) != "undefined") {
        ...
        this.newIndex = e.targElm.cellIndex + (this.handler.length - e.targElm.parentNode.cells.length)
    }
    ...
    if (res) {
        ...
        $I("tblDimensiones_AE").moveRow($I("trdim_" + sDimOrigen + "_AE").rowIndex, $I("trdim_" + sDimDestino + "_AE").rowIndex);
