...
(function($) {
    ...
    */
    var createGrips = function(t) {
        ...
        th.each(function(i) {						//iterate through the table column headers
            if (i >= js_Agrupaciones.length) { return false; }
        ...
        //            if ($(this).cellIndex >= js_Agrupaciones.length) { return false; }
        // 
    ...
    */
    var syncGrips = function(t) {
        ...
        for (var i = 0; i < js_Agrupaciones.length; i++) {	//for each column
            var c = t.c[i];
    ...
    */
    var syncCols = function(t, i, isOver) {
        ...
        var wt = t.w + inc;  //Nueva anchura de la tabla.
        c.width(w + PX);
        ...
        try { $I(t.id).parentNode.style.width = wt; } catch (e) { }
    };

    var syncColsOriginal = function(t, i, isOver) {
        var inc = drag.x - drag.l, c = t.c[i], c2 = t.c[i + 1];
        var w = c.w + inc;
        var w2 = c2.w - inc; //their new width is obtained
        c.width(w + PX);
    ...
    */
    var onGripDrag = function(e) {
        ...
        var max = i == js_Agrupaciones.length - 1 ? t.w - l : t.g[i + 1].position().left - t.cs - mw; //max position according to the contiguous cells
    ...
    */
    var onGripMouseDown = function(e) {
        ...
        if (t.c[o.i].l) {
            for (var i = 0, c; i < t.ln && i < js_Agrupaciones.length; i++) {
    ...
    */
    /* Comentado porque da un error al desplegar el menú. */
