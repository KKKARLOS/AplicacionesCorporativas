<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_ECO_ValorGanadoModal_Default" %>
...
<head  runat="server">
    <title> ::: SUPER ::: - Valor ganado</title>
    <meta http-equiv="X-UA-Compatible" content="IE=8"/>
    <link href="../ValorGanado/css/estilos.css" type="text/css" rel="stylesheet"/>
	...
	<script src="Functions/funciones.js?v=9" type="text/Javascript"></script>
  	<script src="../../../Javascript/boxover.js" type="text/Javascript"></script> 
 	<script src="../../../Javascript/modal.js" type="text/Javascript"></script>
 	<script src="../ValorGanado/Functions/ValorGanado.js" type="text/Javascript"></script>
<style type="text/css">
...
<table id="tblSuperior" class="texto" style="width:990px; margin-left:10px;" cellpadding="3">
    ...
    <tr>
        <td><label id="lblProy" class="texto" onclick="getPE()" style="height:16px;">Proyecto</label></td>
    ...
    <tr>
        ...
        <td><label id="lblMesReferencia" class="enlace" style="width:155px; height:16px; cursor:pointer;" onclick="setMes();" >Mes cerrado de referencia</label>
            <asp:TextBox ID="txtMesReferencia" runat="server" Text="" style="width:90px; text-align:center;" />
        </td>
    </tr>
    <tr>
...
<table id="tblBotonera" style="margin-top:15px;" width="500px">
    <tr>
	    <td>
			<button id="btnGrabar" type="button" onclick="excel();" class="btnH25W95" runat="server" hidefocus="hidefocus" 
				    onmouseover="se(this, 25);mostrarCursor(this);" title="Exporta la información de las diferentes pestañas a Excel">
				<img src="../../../images/botones/imgExcel.gif" /><span title="Grabar">&nbsp;&nbsp;Excel</span>
			</button>	
	    </td>
	    <td>
			<button id="btnEliminar" type="button" onclick="eliminar();" class="btnH25W95" runat="server" hidefocus="hidefocus" disabled
				    onmouseover="se(this, 25);mostrarCursor(this);">
				<img src="../../../images/botones/imgEliminar.gif" /><span title="Elimina la línea base en curso">Eliminar</span>
			</button>	
	    </td>
	    <td>
