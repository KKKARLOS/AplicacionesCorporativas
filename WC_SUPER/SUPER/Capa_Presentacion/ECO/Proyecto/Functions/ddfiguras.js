...
function initDrag(e)	// Mouse button is pressed down on a LI
{
    ...
    if (cloneSourceItems && contentToBeDragged.parentNode.id == 'allItems') {
        ...
        if (newItem.id == "J" || newItem.id == "M") {
            newItem.style.width = "auto";
        }
        newItem.onmousedown = contentToBeDragged.onmousedown;
        contentToBeDragged = newItem;
        contentToBeDragged_src = newItem.parentNode;
        contentToBeDragged_next = false;
    }
...
function dragDropEnd(e) {
    ...
    if (destinationObj.tagName == "UL" || destinationObj.tagName == "IMG" || destinationObj.tagName == "LI") {
        ...
        switch (destinationObj.tagName) {
            case "UL":
                oUL = destinationObj;
                if (destinationObj.parentNode.parentNode.parentNode.getAttribute("tipo") == "F")
                    bEsForaneo = true;
                else {
                    try{
                        if (destinationObj.parentNode.parentNode.parentNode.cells[1].children[0].getAttribute("src").indexOf("imgUsuF") > -1)
                            bEsForaneo = true;
                    }catch(e){}
                }
                break;
            case "LI":
                oUL = destinationObj.parentNode;
                if (destinationObj.parentNode.parentNode.parentNode.parentNode.getAttribute("tipo") == "F")
                    bEsForaneo = true;
                else {
                    try{
                        if (destinationObj.parentNode.parentNode.parentNode.parentNode.cells[1].children[0].getAttribute("src").indexOf("imgUsuF") > -1)
                            bEsForaneo = true;
                    } catch (e) { }
                }
                break;
            case "IMG":
                ...
                if (destinationObj.parentNode.parentNode.parentNode.parentNode.parentNode.getAttribute("tipo") == "F")
                    bEsForaneo = true;
                else {
                    try{
                        if (destinationObj.parentNode.parentNode.parentNode.parentNode.cells[1].children[0].getAttribute("src").indexOf("imgUsuF") > -1)
                ...
                if (destinationObj.src.indexOf("imgDelegado.gif") == -1
	                && destinationObj.src.indexOf("imgColaborador.gif") == -1
	                && destinationObj.src.indexOf("imgJefeProyecto.gif") == -1
	                && destinationObj.src.indexOf("imgSubjefeProyecto.gif") == -1
	                && destinationObj.src.indexOf("imgBitacorico.gif") == -1
	                && destinationObj.src.indexOf("imgSecretaria.gif") == -1
	                && destinationObj.src.indexOf("imgInvitado.gif") == -1) {
                    bEliminar = true;
                }
                break;
        }
        ...
        if (cloneSourceItems && !cloneAllowDuplicates) {
            ...
            if (!clonedItemAllreadyAdded && !comprobarIncompatibilidades(contentToBeDragged, subLi, bEsForaneo)) bEliminar = true;
        }
    } else {
        bEliminar = true;
    }
