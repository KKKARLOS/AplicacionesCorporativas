        ...
        */
	    ...
	    function aceptarClick(indexFila){
		    try{
                ...
                var strDatos = $I("tblDatos").rows[indexFila].getAttribute("idCliente") + "@#@" + $I("tblDatos").rows[indexFila].getAttribute("denominacion");
...
<fieldset style="width:540px; height:40px;">
    <legend>Búsqueda por denominación o CIF</legend>
