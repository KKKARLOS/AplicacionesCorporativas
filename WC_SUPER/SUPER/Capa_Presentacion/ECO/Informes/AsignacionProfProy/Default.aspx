<%@ Page Language="C#" MasterPageFile="~/MasterPages/Plantilla.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_eco_informes_ProfProy_Default" Title="Untitled Page" %>
...
<script type="text/javascript">
    ...
    NODO = "<% if(!String.IsNullOrEmpty(Estructura.getDefCorta(Estructura.sTipoElem.NODO))) { Response.Write((Estructura.getDefCorta(Estructura.sTipoElem.NODO))); }%>";                           
...
<table id="tblCriterios" border="0" cellspacing="0" cellpadding="0">
    ...
    <!-- Inicio del contenido propio de la página -->
        ...
        <tr>
		    <td>
		    <!--
		    Concepto eje<br /><asp:DropDownList id="cboConceptoEje" onchange="nNivelEstructura=0;setLeyenda();setCombo()" runat="server" style="width:200px; vertical-align:middle;" CssClass="combo">
        ...
        <tr>
            ...
            <td colspan="3">
                <FIELDSET id="fld" runat="server" style="width: 290px; height:58px; padding:5px; margin-top:2px;">
				<LEGEND class="Tooltip" title="Profesionales">&nbsp;Profesionales&nbsp;</LEGEND>
				<table class='texto' style="margin-left:35px;">
				    <tr>
				        <td>      					    			   
					        <asp:radiobuttonlist id="rdbConsumos" runat="server" style="width:200px;" SkinId="rbl" RepeatLayout="Table" CellSpacing="0" CellPadding="0"  RepeatDirection="horizontal">
		        ...
		        <table class='texto' style='margin-top:5px; margin-left:10px; width:280px;'>
			        <tr>
			            <td>  
        ...
        <tr>
            ...
            <td colspan="3" rowspan="2" style="vertical-align:top;">
			    <FIELDSET id="FIELDSET1" class="fld" style="height:132px;width:290px; text-align:left" runat="server">
			    <LEGEND class="Tooltip" title="Resultado">&nbsp;Resultado&nbsp;</LEGEND>
		            <table class='texto' style="margin-top:10px;">
                        <tr>
                            <td colspan="2">
		                ...
		                <tr>
			                ...
			                <td style="width:130px; vertical-align:top;">
		                        <FIELDSET id="FIELDSET2" class="fld" style="height: 30px; width:100px; padding-left:10px;" runat="server"> 
                                ...
                                <button id="btnObtener" type="button" onclick="Obtener()" class="btnH25W90" style="margin-left:10px; margin-top:15px;" runat="server" hidefocus="hidefocus" onmouseover="se(this, 25);mostrarCursor(this);">
        ...
        <tr>
            ...
            <td colspan="2" style="vertical-align:top;">
                <FIELDSET id="fldOrden" runat="server" style="width: 290px; height:60px; padding:5px;">
				<LEGEND class="Tooltip" title="Ordenación">&nbsp;Informe&nbsp;</LEGEND>
				<table class='texto' style='margin-top:7px;margin-left:3px;' align='center' border='0' cellspacing='0' cellpadding='0'>
				<tr><td align="center">        					    			   
					<asp:radiobuttonlist id="rdbOrdenacion" runat="server" Width="260px" SkinId="rbl" RepeatLayout="Table" CellSpacing="0" CellPadding="0"  RepeatDirection="horizontal">
						<asp:ListItem Value="1" Selected="True"><IMG SRC="../../../../Images/imgProyProf.gif" style="cursor:pointer" title="Proyectos - Profesionales"/></asp:ListItem>
						<asp:ListItem Value="0">&nbsp;<IMG SRC="../../../../Images/imgProfProy.gif" style="cursor:pointer" title="Profesionales - Proyectos"/></asp:ListItem>
					</asp:radiobuttonlist>
					</td></tr> 
				</table> 						
				</FIELDSET>	   
