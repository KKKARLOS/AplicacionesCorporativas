...
<script type="text/javascript">
    ...
    NODO = "<%=Estructura.getDefLarga(Estructura.sTipoElem.NODO)%>";
    //SSRS

</script>
<table id="tblCriterios" style="margin-top:15px; margin-left:10px;" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <tr>
    ...
    <!-- Inicio del contenido propio de la página -->
        ...
        <tr>
            ...
            <td>
                <FIELDSET style="width:158px; height:56px; margin-top:4px;">
            ...
            <td colspan="2">
                <FIELDSET style="width:115px; height:56px; padding:5px; margin-top:4px; margin-left:10px;">
        ...
        <tr>
            ...
            <td colspan="3">
			    <FIELDSET id="FIELDSET1" class="fld" style="height:90px; width:290px; text-align:left" runat="server">
		            ...
		            <table class='texto' border='0' cellspacing='3' cellpadding='0'>
		                <tr>
	                        ...
	                        <LEGEND class="Tooltip" title="Formato">&nbsp;Formato&nbsp;</LEGEND>
				                <asp:radiobuttonlist id="rdbFormato" runat="server" Width="90px" SkinId="rbli" RepeatDirection="horizontal">
