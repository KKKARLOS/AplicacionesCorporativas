...
function init(){
    try{
        ...
        if ($I('rdbContrato_0').checked) $I('txtTolerancia').readOnly=true;
        else $I('txtTolerancia').readOnly=false;
...
function getCriterios(nTipo){
    try{
        ...
        switch (nTipo){
            ...
            case 38: oTabla = $I("tblSoporteAdm"); break;
        }
        if (nTipo != 1){
	            ...
	            if (ret != null){
                    ...
                    switch (nTipo)
                    {
                        ...
                        case 16: 
                            ...
                            break;
                        case 38:
                            insertarTabla(aElementos, "tblSoporteAdm");
                            break;
        //                case 17:
...
function setTodos() {
    try{
        ...
        setFilaTodos("tblSoporteAdm", (sOL == "1") ? true : false, true);
...
function delCriterios(nTipo){
    try{
        ...
        switch (nTipo)
        {
            ...
            case 38: BorrarFilasDe("tblSoporteAdm"); break;
        ...
        switch (aResul[0]){
           case "generarExcel":
            ...
            case "getPreferencia":
                ...
                $I("cboConceptoEje").value = aResul[3];
                if (aResul[4]=="1") $I('rdbContrato_0').checked=true;
                else $I('rdbContrato_1').checked=true;
                
                if ($I('rdbContrato_0').checked) $I('txtTolerancia').readOnly=true;
                else $I('txtTolerancia').readOnly=false;                
                                
                $I("txtTolerancia").value = (aResul[5] == "" ? 0 : aResul[5]);
                ...
                BorrarFilasDe("tblSoporteAdm");
                insertarFilasEnTablaDOM("tblSoporteAdm", aResul[47], 0);
                $I("divSoporteAdm").scrollTop = 0;

                if (aResul[46]=="1") $I("rdbFormato_0").checked = true;
...
//        sb.Append(nNivelEstructura+"@#@"); //sNivelEstructura 
        ...
        sb.Append(getDatosTabla(14) + "@#@"); //CSN4P
 		...
 		if ($I('rdbContrato_0').checked) sb.Append("1@#@"); //Cuadre
        else  sb.Append("0@#@"); //Cuadre
        
        sb.Append($I("txtTolerancia").value +"@#@"); //sTolerancia
...
//		$I('hdnProveedores').value = getDatosTabla(17);
		...
		$I('hdnSoporteAdm').value = getDatosTabla(38);
		...
		if ($I("cboConceptoEje").value == "1") sConcepto = "C.R.";
		else if ($I("cboConceptoEje").value == "2") sConcepto = "Cliente";
		else if ($I("cboConceptoEje").value == "3") sConcepto = "Responsable del contrato";
		else sConcepto = "";

		var params = {
		    reportName: "/SUPER/sup_contratos",
		    tipo: "PDF",
		    CONCEPTO: sConcepto,
		    t314_idusuario: usuario,
		    nOpcion: $I("cboConceptoEje").value,
		    ...
		    bComparacionLogica: getRadioButtonSelectedValue("rdbOperador"),
		    sCNP: $I("hdnCNP").value,
		    sCSN1P: $I("hdnCSN1P").value,
		    sCSN2P: $I("hdnCSN2P").value,
		    sCSN3P: $I("hdnCSN3P").value,
		    sCSN4P: $I("hdnCSN4P").value,
		    bCuadre: getRadioButtonSelectedValue("rdbContrato"),
		    Tolerancia: parseInt($I("txtTolerancia").value.replace('.', '')),
		    t422_idmoneda: t422_idmoneda,
		    ImportesEn: ImportesEn,
		    sSoporteAdm: $I("hdnSoporteAdm").value
		}
    ...
    try{
        ...
        if (sb.ToString().length > 8000)
        {
            ...
            switch (nTipo)
            {
                ...
                case 38: mmoff("Inf", "Has seleccionado un número excesivo de soportes administrativos.", 450); break;
            }
            return;   
		}
        return sb.ToString();
...
function setPreferencia(){
    try{
        ...
        sb.Append(getRadioButtonSelectedValue("rdbContrato", false) +"@#@");
        sb.Append($I("txtTolerancia").value+"@#@");//                  
    ...
    try{
        ...
        for (var n=1; n<=19; n++){
            ...
            switch (n)
            {
                ...
                case 14: oTabla = $I("tblQ4"); break;
                case 16: oTabla = $I("tblProyecto"); break;
                case 17: oTabla = $I("tblSoporteAdm"); break;
                //case 19: oTabla = tblProveedores; break; 
            }
...
function Limpiar()
{
    ...
    $I('txtTolerancia').value='0';
    $I("rdbContrato_0").checked=true;
    $I('txtTolerancia').readOnly=true;
    setTodos();
}
