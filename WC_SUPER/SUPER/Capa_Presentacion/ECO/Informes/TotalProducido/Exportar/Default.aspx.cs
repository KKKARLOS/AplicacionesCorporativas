...
public partial class TOTAL_PRODUCIDO : System.Web.UI.Page
{
...
//				modificar localizaciones 
            ...
            try
            {
                ...
                rdInforme.Load(Server.MapPath(".") + @"\sup_produccion.rpt");                  
            }
            catch (Exception ex)
            {
                rdInforme.Close();
            ...
            try
            {
                rdInforme.SetParameterValue("CABECERA", "PRODUCCIÓN");


                rdInforme.SetParameterValue("path", Server.MapPath(".") + "//");

                string sConcepto="";
                if (Request.Form[pf + "cboConceptoEje"]=="0") sConcepto="Estructura organizativa"; 
                ...
                rdInforme.SetParameterValue("@sProduccion", Request.Form[pf + "hdnProduccion"]);
