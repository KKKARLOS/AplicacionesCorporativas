...
<table id="tblCriterios" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <!-- Inicio del contenido propio de la página -->
        ...
        <tr>
			<td>				
			Concepto eje<br /><asp:DropDownList id="cboConceptoEje" onchange="nNivelEstructura=0;setLeyenda();" runat="server" style="width:200px; vertical-align:middle;" CssClass="combo">
            ...
            <td>
            Categoría<br /><asp:DropDownList id="cboCategoria" runat="server" style="width:130px; vertical-align:middle;" CssClass="combo">
                <asp:ListItem Value="" Text=""></asp:ListItem>
            ...
            <td>
            Cualidad<br /><asp:DropDownList id="cboCualidad" runat="server" style="width:130px; vertical-align:middle;" CssClass="combo">
                    <asp:ListItem Value="" Text=""></asp:ListItem>
        ...
        <tr>
            ...
            <td colspan="2">
                <FIELDSET style="width: 133px; height:57px; padding:5px; margin-top:3px;">
                    <LEGEND title="Aplicable sólo entre diferentes criterios">Operador lógico</LEGEND>
                    <asp:RadioButtonList ID="rdbOperador" SkinId="rbli" runat="server" RepeatColumns="2" style="margin-top:10px;margin-left:15px;" onclick="setOperadorLogico()">
        ...
        <tr>
            ...
            <td colspan="3" rowspan="2">
                <FIELDSET id="fld" runat="server" style="width: 290px; height:135px; padding:5px;">
				<LEGEND class="Tooltip" title="Formato">&nbsp;Base de cálculo&nbsp;</LEGEND>
				    <asp:CheckBox id="chkProfesionales" runat="server" style="vertical-align:middle;" checked="true" />&nbsp;&nbsp;Profesionales
				    <IMG style="width:1px" src="../../../../Images/imgSeparador.gif">
                    <img src="../../../../images/botones/imgmarcar.gif" onclick="mTabla('AS',1);" title="Marca todas" />
                    &nbsp;
                    <img src="../../../../images/botones/imgdesmarcar.gif" onclick="mTabla('AS',2);" title="Desmarca todas"/>
						&nbsp;&nbsp;Avance del servicio (AS)
                    <br />
				    <IMG style="width:1px" src="../../../../Images/imgSeparador.gif">
                    <img src="../../../../images/botones/imgmarcar.gif" onclick="mTabla('OP',1);" title="Marca todas" />
                    &nbsp;
                    <img src="../../../../images/botones/imgdesmarcar.gif" onclick="mTabla('OP',2);" title="Desmarca todas"/>&nbsp;&nbsp;Otra producción (OP)<br /><br />
                    <DIV class="tblborder" id="divCatalogo" style="overflow:auto; OVERFLOW-X: hidden; WIDTH: 276px; height:65px">
                        <div style="background-image:url('<%=Session["strServer"] %>Images/imgFT16.gif'); width:260px;;">
                            <table id="tblProduccion" class="texto" style="width:260px; height:50px;" cellpadding="0" cellspacing="0" border="0">
                            <%=strHTMLProduccion%>
                            </table>
                        </div>
                    </DIV>
				<!--
				<table class='texto' style='margin-top:7px;margin-left:15px;' align='center' border='0' cellspacing='0' cellpadding='0'>
				<tr><td align="center"></BR>      					    			   
					<asp:radiobuttonlist id="rdbConsumos" runat="server" Width="180px" CssClass="radio texto" RepeatLayout="Table" CellSpacing="0" CellPadding="0"  RepeatDirection="horizontal">
						<asp:ListItem Value="1" Selected="True">&nbsp;&nbsp;Todos&nbsp;&nbsp;&nbsp;</asp:ListItem>
						<asp:ListItem Value="0">&nbsp;&nbsp;Con consumos</asp:ListItem>
					</asp:radiobuttonlist>
					</td></tr> 
				</table></BR>						
		        <table class='texto' style='margin-top:10px;margin-left:3px;' align='center' border='0' cellspacing='0' cellpadding='0'>
			        <tr><td align="center">  
			        <INPUT hideFocus id="chkPropios" class="check" onclick="Control(this,1)" checked type=checkbox  runat="server" />&nbsp;&nbsp;Propios&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			        <INPUT hideFocus id="chkOtros" class="check" onclick="Control(this,2)" checked type=checkbox  runat="server" />&nbsp;&nbsp;De otro&nbsp;<%=Estructura.getDefCorta(Estructura.sTipoElem.NODO) %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			        <INPUT hideFocus id="chkExternos" class="check" onclick="Control(this,3)" checked type=checkbox  runat="server" />&nbsp;&nbsp;Externos
			        </td></tr> 
		        </table> 
		        -->
		        </FIELDSET>	
        ...
        <tr>
            <td colspan="3" style="vertical-align:bottom;">
                ...
                <nobr id="imgLeyProy" style="display:none">
                <img class="ICO" src="../../../../Images/imgIconoProyPresup.gif" title='Proyecto presupuestado' />
                <img class="ICO" src="../../../../Images/imgIconoProyAbierto.gif" title='Proyecto histórico' />
                <img class="ICO" src="../../../../Images/imgIconoProyCerrado.gif" title='Proyecto cerrado' />
                <img class="ICO" src="../../../../Images/imgIconoProyHistorico.gif" title='Proyecto cerrado' />&nbsp;Proyecto</nobr>
            </td>
            <td colspan="3">
	                ...
	                <tr>
		                ...
		                <tr>
			                ...
			                <td style="width:130px; vertical-align:top;">
		                        <FIELDSET id="FIELDSET2" class="fld" style="height: 30px;width:90px; padding-left:5px;" runat="server"> 
		                        <LEGEND class="Tooltip" title="Formato">&nbsp;Formato&nbsp;</LEGEND>
					                <asp:radiobuttonlist id="rdbFormato" runat="server" Width="100px" SkinId="rbli" RepeatLayout="Table" CellSpacing="0" CellPadding="0"  RepeatDirection="horizontal">
                                ...
                                <button id="btnObtener" type="button" onclick="Obtener()" class="btnH25W90" style="margin-left:8px; margin-top:5px;" runat="server" hidefocus="hidefocus" onmouseover="se(this, 25);mostrarCursor(this);">
...
<asp:textbox id="hdnIdsCptosProfesionales" runat="server" style="visibility:hidden;"></asp:textbox>
<asp:textbox id="hdnProduccion" runat="server" style="visibility:hidden;"></asp:textbox>
<asp:textbox id="hdnProducPref" runat="server" style="visibility:hidden;"></asp:textbox>
