<%@ Page Language="C#" MasterPageFile="~/MasterPages/Plantilla.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_eco_informes_ConsumosProveedJornOtros_Default" Title="Untitled Page" %>
...
<script type="text/javascript">
    ...
    NODO = "<%=Estructura.getDefCorta(Estructura.sTipoElem.NODO)%>";
  ...
  <tr>
    ...
    <!-- Inicio del contenido propio de la página -->
        ...
        <tr>
            ...
            <td colspan="2">
                <FIELDSET style="width: 133px; height:63px; padding:5px;">
        ...
        <tr>
            ...
            <td colspan="3">
			    <FIELDSET id="FIELDSET1" class="fld" style="height:120px; width:290px; text-align:left" runat="server">
			    <LEGEND class="Tooltip" title="Resultado">&nbsp;Resultado&nbsp;</LEGEND>
		            <table class='texto' style="width:285px;" cellspacing='3'>
		                <colgroup><col style="width:140px"/><col style="width:145px"/></colgroup>
		                <tr>
		                    <td colspan="2">
                                <div id="divMonedaImportes" runat="server" style="visibility:hidden; width:280px; margin-top:10px;">
		                ...
		                <tr>
			                ...
			                <td style="vertical-align:top; text-align:center;" >
		                        ...
		                        <LEGEND class="Tooltip" title="Formato">&nbsp;Formato&nbsp;</LEGEND>
					                <asp:radiobuttonlist id="rdbFormato" runat="server" Width="90px" SkinId="rbli" RepeatLayout="Table" RepeatDirection="horizontal">
						                <asp:ListItem Value="1" Selected="True">
						                    <img src="../../../../Images/botones/imgPDF.gif" style="cursor:pointer" onclick="$I('rdbFormato_0').checked=true" title="PDF">
						                </asp:ListItem>
						                <asp:ListItem Value="0">
						                    <img src="../../../../Images/botones/imgExcel.gif" style="cursor:pointer" onclick="$I('rdbFormato_1').checked=true" title="Excel">
						                </asp:ListItem>
					                </asp:radiobuttonlist>
	                            </FIELDSET>
	                            <br />  							
                                <button id="btnObtener" type="button" onclick="Obtener()" class="btnH25W90" style="margin-left:15px;" runat="server" hidefocus="hidefocus" onmouseover="se(this, 25);mostrarCursor(this);">
