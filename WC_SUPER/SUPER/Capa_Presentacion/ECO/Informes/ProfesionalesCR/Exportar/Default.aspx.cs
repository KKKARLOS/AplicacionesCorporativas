...
public partial class RECURSOS_EXTERNOS_SUB : System.Web.UI.Page
{
...
//				modificar localizaciones 
            ...
            try
            {
                rdInforme.Load(Server.MapPath(".") + @"\sup_profesionalesCR.rpt");
            }
            catch (Exception ex)
            {
                rdInforme.Close();
            ...
            string sCodigos = Request.Form[pf + "CODIGO"];
            ...
            try
            {
                 if (SUPER.Capa_Negocio.Utilidades.EsAdminProduccion())
                    ...
                    rdInforme.SetParameterValue("@t314_idusuario", (int)Session["UsuarioActual"]);

                rdInforme.SetParameterValue("@ESTADO", Request.Form[pf + "ESTADO"]);
                rdInforme.SetParameterValue("@CODIGO", sCodigos);
