...
public partial class getCliente : System.Web.UI.Page, ICallbackEventHandler
{
    ...
    public string sErrores = "", sInterno = "0", sSoloActivos = "0";
    ...
    public void RaiseCallbackEvent(string eventArg)
    {
        ...
        {
            case ("cliente"):
                sResultado += ObtenerClientes(aArgs[1], aArgs[2], aArgs[3], aArgs[4]);
                break;
        }
    ...
    private string ObtenerClientes(string sTipoBusqueda, string strCli, string sInterno, string sSoloActivos)
    {
        try
        {
            ...
            sb.Append("<tbody>");
            SqlDataReader dr = CLIENTE.SelectByNombre(Utilidades.unescape(strCli), sTipoBusqueda, (sSoloActivos == "1") ? true : false, (sInterno == "1") ? true : false, null);
            ...
            while (dr.Read())
            {
                ...
                sb.Append("idCliente='" + dr["t302_idcliente"].ToString() + "' ");
                sb.Append("denominacion='" + dr["t302_denominacion"].ToString() + "' ");
                //Los clientes que quiero ver ya vienen filtrados por el parámetro sSoloActivos. 
                //Una vez que los veo no tiene sentido deshabilitarlos
                //if ((bool)dr["t302_estado"])
                //    sb.Append(" onclick=\"msse(this)\" ondblclick=\"aceptarClick(this.rowIndex)\" style='height:16px;'");
                //else
