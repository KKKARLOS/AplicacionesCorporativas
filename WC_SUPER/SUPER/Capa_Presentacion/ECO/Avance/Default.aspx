                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div id="divMonedaImportes2" runat="server" style="visibility:hidden">
                                    <label id="lblLinkMonedaImportes2" class="enlace" style="vertical-align:bottom" onclick="getMonedaImportes()">Importes</label>&nbsp;&nbsp;<label style="vertical-align:top"> en </label>&nbsp;&nbsp;<label id="lblMonedaImportes2" style="vertical-align:top" runat="server">Dólares americanos</label>
                                </div>
                            </td>
                        </tr>
                        </table>
		...
		<td style="vertical-align:bottom;" align="left">
            ...
            <table id="tblTituloMovil" style="width: 1185px; height: 34px; z-index:5;">
	            ...
	            <tr class="texto" align="center">
                    ...
                    <td colspan="3" class="colTabla1">Económico</td>
	            </tr>
