<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getCNP.aspx.cs" Inherits="getCNP" %>
...
<head runat="server">
<base target="_self" />
    <title> ::: SUPER ::: - Selección de cualificador departamental de proyecto</title>
    ...
    function aceptarClick(indexFila){
	    try{
            ...
            var sTexto = (ie) ? $I("tblDatos").rows[indexFila].innerText : $I("tblDatos").rows[indexFila].textContent;
...
<body style="overflow:hidden; margin-left:10px; margin-top:15px;" onload="init()">
<ucproc:Procesando ID="Procesando" runat="server" />
    ...
    <table border="0" class="texto" width="370px" style="margin-left:10px;" cellpadding="5px">
        <tr>
            <td>
