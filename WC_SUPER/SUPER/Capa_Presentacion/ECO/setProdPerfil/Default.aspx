...
<head runat="server">
    <title> ::: SUPER ::: - Producción por perfil</title>
...
<div id="divMonedaImportes" runat="server" style="position:absolute; top:5px; left:430px; width:300px; visibility:hidden;">
	...
	<!--
	    ...
	    var bHayProdProf = <%=sAgrupado%>;
	    var sModoTarificacion = opener.$I("hdnModeloTarificacion").value;
    	var sUltCierreEcoNodo = opener.sUltCierreEcoNodo;
	    var sEstado = "<%=Request.QueryString["sEstadoProy"]%>";
	-->
    </script>
    <center>
    <table cellpadding="3" style="width: 720px; text-align:left; margin-top:15px;">
        <tr>
    ...
    <tr>
        <td>
            <table id="tblTitulo" style="width: 700px; height: 17px; margin-top:25px;">
            <colgroup>
            ...
            <tr class='TBLINI'>
                <td style='padding-left:15px;'>Perfil</td>
                <td style='text-align:right;'><label id="lblModoCoste"></label></td>
                <td style='text-align:right;'><label id="lblUnidades"></label></td>
                <td style='text-align:right; padding-right:2px;' title="Importe a facturar">Imp. a facturar</td>
                </tr>
            </table>
		    <div id="divCatalogo" style="overflow: auto; overflow-x: hidden; width: 716px; height:400px" runat="server">
                <div style="background-image:url(<%=Session["strServer"] %>Images/imgFT20.gif); width:700px">
		            <%=strTablaHTML%>
		        </div>
		    </div>
		    <table id="tblAvance" style="width: 700px; height: 17px;">
            <colgroup>
			    ...
			    <tr class="TBLFIN">
				    ...
				    <td align="right" style="padding-right:2px;"><input type="text" id="txtAvanProd" class="txtNumL" style="width:90px; cursor:pointer" value="0,00" onkeyup="if(!bLectura){activarGrabar();}" onfocus="if(!bLectura){this.className='txtNumM';fn(this);}" onchange="this.className='txtNumL';calcularTotal()" readonly="true" runat="server" /></td>
			    </tr>
		    </table>
