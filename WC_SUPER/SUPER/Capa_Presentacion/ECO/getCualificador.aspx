<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getCualificador.aspx.cs" Inherits="getCualificador" %>
...
<head runat="server">
<base target="_self" />
    <title> ::: SUPER ::: - Selección de cualificador de ventas</title>
...
<ucproc:Procesando ID="Procesando" runat="server" />
    ...
    <table class="texto" style="margin-left:10px; margin-top:20px; width:410px;" cellpadding="5" >
        <tr>
            <td>
                <table id="tblTitulo" style="width:390px; height:17px">
                    <tr class="TBLINI">
                ...
                <div id="divCatalogo" style="overflow: auto; overflow-x: hidden; width: 406px; height:384px">
                    <div style="background-image:url('<%=Session["strServer"] %>Images/imgFT20.gif'); width:390px;">
                    <%=strTablaHTML %>
                    </div>
                </div>
                <table style="width:390px; height:17px;">
                    <tr class="TBLFIN">
                        <td></td>
                    </tr>
                </table>
