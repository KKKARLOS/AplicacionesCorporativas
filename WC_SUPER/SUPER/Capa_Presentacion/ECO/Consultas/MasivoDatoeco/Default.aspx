    ...
    <!-- Inicio del contenido propio de la página -->
        <table class="texto" style="width:940px;">
            ...
            <tr>
			    <td>
                    <FIELDSET style="width: 290px; height:50px;">
                        <LEGEND>
                            <label id="lblClaseEco" class="enlace" onclick="getCriterios(19)" runat="server">Clase Económica</label>
                            <img id="Img19" src='../../../../Images/Botones/imgBorrar.gif' border='0' onclick="delCriterios(19)" runat="server" style="cursor:pointer; vertical-align:middle; margin-left:10px;">&nbsp;&nbsp;
                            <label id="lblGrupoEco" runat="server"></label>
                        </LEGEND>
                        <DIV id="divClaseEco" style="overflow-x:hidden; overflow-y:auto; width:276px; height:32px;">
                            <div style="background-image:url('<%=Session["strServer"] %>Images/imgFT16.gif'); width:260px;">
                             <table id="tblClaseEco" class="texto" style="width:260px;">
                             <%=strHTMLClaseEco%>
                             </table>
                            </div>
                        </DIV>
			        ...
			        <table style="width:320px;">
			            <tr>
			                <td style="width:160px; vertical-align:top;">
				                <img src='../../../../Images/imgPreferenciasGet.gif' border='0' title="Muestra el catálogo de preferencias" onclick="getCatalogoPreferencias()" style="cursor:pointer; vertical-align:top; margin-top:30px;">
				                <img src='../../../../Images/imgPreferenciasAdd.gif' border='0' title="Almacena preferencia" onclick="setPreferencia()" style="cursor:pointer; vertical-align:top; margin-top:30px;">
				                <img src='../../../../Images/imgPreferenciasDel.gif' border='0' title="Elimina todas las preferencias" onclick="delPreferencia()" style="cursor:pointer; vertical-align:top; margin-top:30px;">
				                <img src='../../../../Images/imgPrefRefrescar.gif'   border='0' title="Borra los criterios seleccionados" onclick="Limpiar();" style="cursor:pointer; vertical-align:top; margin-top:30px;">
                            </td>
                            <td style="width:160px; vertical-align:top;">
                                <div id="divOnline" style="width:170px; z-index:0;">
                                    <div style="background-image: url('../../../../Images/imgFondoCal3.gif'); background-repeat:no-repeat; width:90px; height:23px; position: relative; top: 15px; left:20px; padding-top:5px;">
                                        &nbsp;&nbsp;Base de cálculo
                                    </div>
                    ...
                    <FIELDSET style="width: 290px; height:52px;">
                        <LEGEND>
                            ...
                            <span id="spanClientesSector" style="margin-left:20px;" runat="server">
                                ...
                                <asp:CheckBox ID="chkSectorCG" runat="server" Checked="true" style="vertical-align:middle" /> 
                    ...
                    <FIELDSET style="width: 290px; height:52px;">
                        <LEGEND><label id="Label6" class="enlace" onclick="getCriterios(7)" runat="server">Segmento</label><img id="Img3" src='../../../../Images/Botones/imgBorrar.gif' border='0' onclick="delCriterios(7)" runat="server" style="cursor:pointer; vertical-align:middle; margin-left:10px;">
                            <span id="spanClientesSegmento" style="margin-left:20px;" runat="server">
                                <label id="lblSegmentoCG" title="Cliente de gestión">CG</label><asp:CheckBox ID="chkSegmentoCG" runat="server" Checked="true" style="vertical-align:middle" /> <label id="lblSegmentoCF" title="Cliente de facturación">CF</label><asp:CheckBox ID="chkSegmentoCF" runat="server" style="vertical-align:middle" />
                            </span>
                        </LEGEND>
            ...
            <tr>
                ...
                <td colspan="3">
                    <FIELDSET id="fstCliFact" style="width: 290px; height:50px;">
            ...
            <tr>
                ...
                <td colspan="3" style="vertical-align:top;">
                    <FIELDSET id="fstSociedad" runat="server" style="width: 290px; height:50px;">
                        <LEGEND><label id="lblSociedad" class="enlace" onclick="if (this.className=='enlace') getCriterios(21)" runat="server">Empresa de facturación</label><img id="Img21" src='../../../../Images/Botones/imgBorrar.gif' border='0' onclick="delCriterios(21)" runat="server" style="cursor:pointer; vertical-align:middle; margin-left:10px;"></LEGEND>
            ...
            <tr>
                <td style="vertical-align:top;">
                    <FIELDSET id="fstPais" style="width: 290px; height:52px;">
                        <LEGEND>
                            ...
                            <span id="spanClientesPais" style="margin-left:20px;" runat="server">
                                <label id="lblPaisCG" title="Cliente de gestión">CG</label>
                                <asp:CheckBox ID="chkPaisCG" runat="server" Checked="true" style="vertical-align:middle" /> 
                                <label id="lblPaisCF" title="Cliente de facturación">CF</label>
                                <asp:CheckBox ID="chkPaisCF" runat="server" style="vertical-align:middle" />
                            </span>                       
                        </LEGEND>
                    ...
                    <FIELDSET id="fstProvincia" runat="server" style="width: 290px; height:50px;">
                        <LEGEND>
                            ...
                            <img id="Img13" src='../../../../Images/Botones/imgBorrar.gif' border='0' onclick="delCriterios(35)" 
                                runat="server" style="cursor:pointer; vertical-align:middle; margin-left:10px;">
                            <span id="spanClientesProvincia" style="margin-left:20px;" runat="server">
                                <label id="lblProvinciaCG" title="Cliente de gestión">CG</label>
								<asp:CheckBox ID="chkProvinciaCG" runat="server" Checked="true" style="vertical-align:middle" /> 
								<label id="lblProvinciaCF" title="Cliente de facturación">CF</label>
								<asp:CheckBox ID="chkProvinciaCF" runat="server" style="vertical-align:middle" />
                            </span>		
                        </LEGEND>
...
<asp:textbox id="hdnClasesEco" runat="server" style="visibility:hidden;"></asp:textbox>
