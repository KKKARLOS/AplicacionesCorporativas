            ...
            <table style="width: 550px;">
                ...
                <tr>
				    ...
				    <td style="vertical-align:bottom;">
				        <input id="chkBajas" hidefocus class="check" type="checkbox" runat="server" style="margin-left:5px;" onclick="javascript:mostrarRelacionTecnicos();">&nbsp;Mostrar bajas<img src="../../../../../../Images/imgMarcarTodo.gif" style="cursor:pointer; vertical-align:bottom;margin-left:9px" title="Seleccionar todas las filas" onclick="MarcarTodo('tblDatos')" />&nbsp;<img src="../../../../../../Images/imgDesmarcarTodo.gif" style="cursor:pointer; vertical-align:bottom;" title="Quitar selección a todas las filas" onclick="DesmarcarTodo('tblDatos')" />
				    </td>                    
                </tr>
            </table>
		</td>
