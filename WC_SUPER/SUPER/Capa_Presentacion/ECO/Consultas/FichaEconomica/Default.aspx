...
<table id="tblGeneral" height="20" class="texto" width="990px" style="margin-top:20px; margin-left:10px; margin-bottom:10px;" cellSpacing="0" cellPadding="0" border="0">
    <tr>
        <td>
            &nbsp;
            <img id="imgNE1" src='../../../../images/imgNE1off.gif' class="ne" onclick="setNE(1);"><img id="imgNE2" src='../../../../images/imgNE2off.gif' class="ne" onclick="setNE(2);"><img id="imgNE3" src='../../../../images/imgNE3off.gif' class="ne" onclick="setNE(3);">
        </td>
    </tr>
    <tr>
        <td>
            ...
            <div id="divCatalogo" style="overflow-x:auto; overflow-y:scroll; width:986px; height:440px;" onscroll="moverScroll(event);">
                <div id="divPijama" style="background-image:url('<%=Session["strServer"] %>Images/imgFT20.gif'); width:424px;">
                <%=strTablaHTML%>
                </div>
            </div>
            <div id="divResultadoTotales" style="overflow-x:hidden; width: 970px; height:68px; background-image: url(../../../../Images/fondoTotalResListas68.gif)" runat="server">
            <TABLE id="tblTotales" style="width:970px; height:68px;" cellpadding="0">
                <colgroup>
