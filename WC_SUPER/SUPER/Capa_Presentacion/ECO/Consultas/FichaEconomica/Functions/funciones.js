...
function init(){
    try{
        ...
        oDivResultado = $I("divResultadoTotales");
    ...
    if (aResul[1] != "OK"){
        ...
        switch (aResul[0]){
            case "buscar":
                ...
                $I("divResultadoTotales").innerHTML = aResul[4];
    ...
    try{
        ...
        for (var i=nIndexFila+1; i<$I("tblDatos").rows.length; i++){
            if ($I("tblDatos").rows[i].getAttribute("nivel") > nNivel){
                ...
                else if ($I("tblDatos").rows[i].getAttribute("nivel") - 1 == nNivel)
...
function borrarCatalogo(){
    try{
        ...
        $I("divResultadoTotales").innerHTML = "";
...
//        $I("divResultadoTotales").style.width = "1230px";
            ...
            for (var i=0; i<$I("tblDatos").rows.length;i++){
                if ($I("tblDatos").rows[i].getAttribute("nivel") > 1)
                {
                    if ($I("tblDatos").rows[i].getAttribute("nivel") < 3)
                        if ($I("tblDatos").rows[i].cells[0].children[0].src.indexOf("imgSeparador.gif") == -1)
                            $I("tblDatos").rows[i].cells[0].children[0].src = "../../../../images/plus.gif";
