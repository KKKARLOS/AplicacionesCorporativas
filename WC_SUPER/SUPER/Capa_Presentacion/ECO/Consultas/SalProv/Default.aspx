  ...
  <tr>
    ...
    <!-- Inicio del contenido propio de la página -->
        ...
        <tr>
			...
			<td>				
			    Concepto eje<br />
			    <asp:DropDownList id="cboConceptoEje" onchange="nNivelEstructura=0;setLeyenda();" runat="server" style="vertical-align:middle;" CssClass="combo">
            ...
            <td>
                Categoría<br />
                <asp:DropDownList id="cboCategoria" runat="server" Width="130px" CssClass="combo">
                    <asp:ListItem Value="" Text=""></asp:ListItem>
            ...
            <td>
                Cualidad<br />
                <asp:DropDownList id="cboCualidad" runat="server" Width="130px" CssClass="combo">
                    <asp:ListItem Value="" Text=""></asp:ListItem>
        ...
        <tr>
            ...
            <td colspan="3">
				    ...
				    <table class="texto" style="width: 280px; margin-top:5px;" cellpadding=3 cellspacing=0 border="0">
                        <tr>
                            <td align="center">
				            <asp:CheckBox id="chkSubcontratacion" runat="server" style="vertical-align:middle;" checked="true" onclick="Control(this,1)"/><label style="cursor:pointer; margin-left:5px;" onclick="this.previousSibling.click()" />Subcontratación</label>
				            <asp:CheckBox id="chkCompras" runat="server" style="vertical-align:middle; margin-left:30px;" checked="true" onclick="Control(this,2)" /><label style="cursor:pointer; margin-left:5px;" onclick="this.previousSibling.click()" />Compras</label>
				            </td>
                        </tr>
                    </table>
		            </FIELDSET>	
		            ...
		            <table class='texto' border='0' cellspacing='3' cellpadding='0'>
		                ...
		                <tr>
			                ...
			                <td style="width:130px; vertical-align:top;">
		                        <FIELDSET id="FIELDSET2" class="fld" style="height:30px; width:100px; text-align:center; padding-left:5px;" runat="server"> 
                                ...
                                <button id="btnObtener" type="button" onclick="Obtener()" class="btnH25W90" style="margin-left:10px; margin-top:5px;" runat="server" hidefocus="hidefocus" onmouseover="se(this, 25);mostrarCursor(this);">
