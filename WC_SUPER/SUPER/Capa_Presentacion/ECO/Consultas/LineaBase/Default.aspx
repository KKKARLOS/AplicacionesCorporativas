...
<table class="texto" id="tblGeneral" style="width:960px; margin-left:5px; margin-top:5px;" cellSpacing="0" cellPadding="5" border="0">
	<tr>
		<td>
			<table id="tblTitulo" style="width:960px; height:17px;" cellSpacing="0" cellPadding="0" border="0">
			    <colgroup>
			...
			<div id="divCatalogo" style="OVERFLOW: auto; OVERFLOW-X: hidden; WIDTH: 976px; HEIGHT: 480px;" onscroll="scrollTablaProy();">
                <div style="background-image: url('../../../../Images/imgFT20.gif'); background-repeat:repeat; width:960px; height:auto;">
                <%=strTablaHTML%>
                </div>
            </div>
            <table id="tblResultado" style="height:17px; width:960px;" cellSpacing="0" cellPadding="0" border="0">
				<tr class="TBLFIN">
					<td>&nbsp;</td>
				</tr>
			</table>
