...
//ojo se pone para las pruebas de mejora de las preferencias        
            ...
            if (fOpener().js_cri[i].t == nTipo) {
                var oNF = $I("tblDatos").insertRow(-1);
                oNF.id = fOpener().js_cri[i].c;
                oNF.style.height = "20px";
                //if (nTipo != 16) oNF.onmouseover = function() { TTip(event) };
                ...
                var oLabel = document.createElement("nobr");
                //oLabel.setAttribute("style", "vertical-align:middle; width:340px; cursor:" + strCurMAM);
                oLabel.setAttribute("style", "vertical-align:middle; width:340px;");
                oLabel.className = "NBR";
                //oLabel.style.backgroundColor = "Red";
                //oLabel.style.cursor = strCurMM;
                oLabel.innerText = Utilidades.unescape(fOpener().js_cri[i].d);
                oNC.appendChild(oLabel); 

//            
//                sb.Append("<tr id='" + opener.js_cri[i].c + "' style='height:20px;' ");
//                if (nTipo != 16) sb.Append("onmouseover='TTip(event)' ");
//                sb.Append("onclick='mmse(this)' ondblclick='insertarItem(this)' onmousedown='DD(this)'>");
//                sb.Append("<td><nobr class='NBR W340'>" + Utilidades.unescape(opener.js_cri[i].d) + "</nobr></td>");
//                sb.Append("</tr>");
            }
        }
...
function cargarCriteriosSeleccionados(){
    try{
        ...
        for (var i = 0; i < fOpener().js_Valores.length; i++) {
            ...
            if (aDatos[0] !=""){
//                sb.Append("<tr id='" + aDatos[0] + "' style='height:20px;' onmouseover='TTip()' ");
//                //if (nTipo != 16) sb.Append("onmouseover='TTip()' ");
//                sb.Append("onclick='mmse(this)' onmousedown='DD(this)'>");
