...
function getCriterios(nTipo){
    try{
        if (js_cri.length == 0 && bCargandoCriterios && es_administrador == ""){
            ...
            mmoff("InfPer", "Actualizando valores de criterios... Espere, por favor", 400);
            return;
        }
...
//		$I('hdnNivelEstructura').value = nNivelEstructura;
		...
		var params = {
		    reportName: "/SUPER/sup_consuconta",
		    tipo: "PDF",
		...
		if ($I("hdnConceptoContable").value != "") params["t329_idclaseeco"] = $I("hdnConceptoContable").value;
