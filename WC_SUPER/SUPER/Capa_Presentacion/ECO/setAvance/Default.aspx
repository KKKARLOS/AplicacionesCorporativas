...
<head id="Head1" runat="server">
    <title> ::: SUPER ::: - Avance de producción</title>
...
<div id="divMonedaImportes" runat="server" style="position:absolute; top:5px; left:10px; width:300px; visibility:hidden;">
    <table class="texto" style="width:300px; table-layout:fixed; border-collapse:collapse; margin-top:0px;" border="0" cellpadding="3">
    <tr>
	...
	<script type="text/javascript">
        ...
        <table cellpadding="3" style="width: 520px; margin-top:45px; text-align:left">
            ...
            <tr>
                ...
                <td><input type="text" id="txtAvanProd" class="txtNumM" style="width:90px; cursor:pointer" value="0,00" onkeyup="if(!bLectura){activarGrabar();}" onfocus="if(!bLectura){fn(this);}"  readonly="true" runat="server" /></TD>
            </tr>
        </table>
        <center>
