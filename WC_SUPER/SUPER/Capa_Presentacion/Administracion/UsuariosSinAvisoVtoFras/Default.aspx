<%@ Page Language="C#" MasterPageFile="~/MasterPages/Plantilla.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="USUARIOSSINAVISOVTOFRAS" %>
...
<table cellpadding="4" style="width:990px;">
    ...
    <tr>
        <td><!-- Relación de Items --> 
            ...
            <div id="divCatalogo" style="overflow: auto; overflow-x: hidden; width: 466px; height:440px" runat="server" onscroll="scrollTabla()">
        ...
        <td><!-- Items asignados -->
            <table id="tblAsignados" style="width: 450px; height: 17px">
                ...
                <tr class="TBLINI">
                    <td style="padding-left:5px">Profesionales sin aviso de vencimiento de facturas
