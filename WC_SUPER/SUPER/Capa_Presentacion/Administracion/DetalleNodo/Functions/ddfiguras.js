...
function initDrag(e)	// Mouse button is pressed down on a LI
{
    ...
    if (cloneSourceItems && contentToBeDragged.parentNode.id == 'allItems') {
        ...
        if (newItem.id == "D" || newItem.id == "C" || newItem.id == "I" || newItem.id == "G" || newItem.id == "S" || newItem.id == "P") {
        ...
        switch (destinationObj.tagName) {
            ...
            case "IMG":
                ...
                if (destinationObj.src.indexOf("imgInvitado.gif") == -1
	                ...
	                && destinationObj.src.indexOf("imgPerseguidor.gif") == -1
	                && destinationObj.src.indexOf("imgGestor.gif") == -1) {
                    bEliminar = true;
                }
                break;
        }
