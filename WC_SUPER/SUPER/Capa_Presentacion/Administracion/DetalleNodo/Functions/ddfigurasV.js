...
function initDragV(e)	// Mouse button is pressed down on a LI
{
    ...
    //    //if (this.nextSibling) {
    //    if (getNextElementSibling(oObject)) {
    //        //contentToBeDragged_next = this.nextSibling;
    //        contentToBeDraggedV_next = getNextElementSibling(this);

    //        //if (!this.tagName && contentToBeDragged_next.nextSibling) contentToBeDragged_next = contentToBeDragged_next.nextSibling;
    //        if (!this.tagName && getNextElementSibling(contentToBeDraggedV_next)) contentToBeDraggedV_next = getNextElementSibling(contentToBeDraggedV_next);

    //        //if (!oObject.tagName && contentToBeDragged_next.nextSibling) contentToBeDragged_next = contentToBeDragged_next.nextSibling;
    //    }
