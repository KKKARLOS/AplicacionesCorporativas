...
<img id="imgCaution" src="../../../Images/imgCaution.gif" border=0 style="display:none; position:absolute; top:145px; left:800px;" title="Existen nodos a procesar con proyectos que ya tienen datos de obra en curso del año de referencia." />
<center>
              ...
              <tr>
                ...
                <table id="tblEstadisticas" class="texto" style="width: 560px;" cellpadding="3">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>Con POCAFL: </td>
                        <td id="cldPocafl" align="right">0</td>
                    </tr>
                    <tr>
                        <td>Seleccionados para proceso:</td>
                        <td id="cldEstNodoSel" align="right">0</td>
                        <td></td>
                        <td>Con POCAFL y seleccionados para proceso: </td>
                        <td id="cldPocaflSel" align="right">0</td>
                    </tr>
                </table>
...
<tr>
    <td>
        <table style="width: 600px;">
            ...
            <tr>
                <td style="padding-left:1px; vertical-align:bottom">
				...
				<td style="vertical-align:top;" align="right" colspan="3">	
					...
					<tr>
                        <td align="center" valign="bottom">
			                Nº Meses Antiguedad:&nbsp;<asp:TextBox id="txtMesesAntig" runat="server" Text="6" SkinID='Numero' onkeypress="vtn(event);" onchange="cambiarMes('');" MaxLength="2" style="width:20px;" />				               
                        </td>
				        <td align="right" valign="middle">
                            <div align="center" class="texto" style="background-image: url('../../../Images/imgFondoCal100.gif');background-repeat:no-repeat;
                                width:100px; height:23px; position:relative; top:12px; left:-30px; padding-top: 5px;">
                                Año-Mes de Cierre</div>
            ...
            <tr id="tblTitulo" class="TBLINI">
                ...
                <td align="center" title="Proyectos con obra en curso antigua a la fecha límite">POCAFL</td>
            </tr>
        </table>
        <div id="divCatalogo" style="overflow:auto; width: 616px; height:380px;">
