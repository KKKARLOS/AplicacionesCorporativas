        ...
        <table style="width: 600px; margin-top:10px;">
            ...
            <tr>
				...
				<td style="vertical-align:middle;" align="right" colspan="2">
				    <label style="vertical-align:middle;">Año de aplicación de ajuste al 20% de obra en curso</label>
                    <img title="Año anterior" onclick="setAnno('A')" src="../../../Images/btnAntRegOff.gif" style="cursor: pointer;vertical-align:middle" />
                    ...
                    <img title="Siguiente año" onclick="setAnno('S')" src="../../../Images/btnSigRegOff.gif" style="cursor: pointer;vertical-align:middle" />
				</td>
                <td align='center'></td>
            </tr>
            <tr id="tblTitulo" class="TBLINI">
                ...
                <td align="center" title="Proyectos con obra en curso en el año de referencia">POCAR</td>
            </tr>
        </table>
