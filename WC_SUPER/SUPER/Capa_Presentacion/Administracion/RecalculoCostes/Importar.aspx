		...
		<form id="Form1" method="post" runat="server">
			...
			<br />
                <table width="100%">
                    ...
                    <tr> 
                    <td>
                      <div align="center">Los elementos de la lista (código Iberper y coste anual), deberán estar separados entre sí por un tabulador y entre filas por un salto de línea. No puede haber códigos Iberper repetidos. El coste anual deberá ir sin formatear y con coma decimal.<br /><br />
