<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_Administracion_AlertasPrioridad_Default" %>
...
<head runat="server">
    ...
    <title>::: SUPER ::: Mantenimiento prioridades en alertas</title>  
...
<body>
    ...
    <div class="container-fluid">
        <h1 class="hiddenStructure">::: SUPER ::: Mantenimiento prioridades en alertas</h1>  
        <br class="visible-xs" />
                            ...
                            <div class="form-group row">		
                                <div class="col-xs-12 col-md-12">
					                <fieldset class="fieldset">
                                        <h2 class="hiddenStructure">prioridades en alertas</h2>           
						                <legend class="fieldset"><span class="text-nowrap">Prioridades en alertas</span></legend>
                                            <div class="row">
                                                <div class="col-xs-12">	
                                                    ...
                                                    <table id="tabla" class="table table-bordered table-condensed">
                                                        <thead>    
                                                            <tr>
                                                                <th data-type="String" class="bg-primary ">Grupo</th>
                                                                <th data-type="String" class="bg-primary ">Alerta 1</th>
                                                                <th data-type="String" class="bg-primary ">Alerta 2</th>
                                                                <th data-type="String" class="bg-primary ">Alerta Ganadora</th>
                                                            </tr>
                                                        </thead>
                    ...
                    <div class="row row-modal">
                        <div class="col-xs-12">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="cbo1">Alerta 1</label>
                                <div class="col-sm-8">
                                    <select id="cboAlert1" name="alerta1" class="form-control"></select>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="txtDen2">Alerta 2</label>
                                <div class="col-sm-8">
                                    <select id="cboAlert2" name="alerta2" class="form-control"></select>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="cboG">Ganadora</label>
                                <div class="col-sm-8">
                                    <select id="cboAlertG" name="alertaG" class="form-control">
                                    </select>  	
                                </div>
                            </div>
                        </div>
...
<script src="js/view.js?20170524_06" type="text/javascript"></script>
<script src="js/app.js?20170524_06" type="text/javascript"></script>
