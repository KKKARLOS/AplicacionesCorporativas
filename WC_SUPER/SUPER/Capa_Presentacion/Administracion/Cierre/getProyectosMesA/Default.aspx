...
<head id="Head1" runat="server">
    <title> ::: SUPER ::: - Proyectos con meses abiertos</title>
...
<table style="width:960px; margin-left:10px;text-align:left" cellpadding="5px">
	<tr>
		<td>
			<table id="tblTitulo" style="width:960px;margin-top:10px; height:17px;">
				...
				<tr class="TBLINI" style="height:17px;">
					...
					<td><IMG style="CURSOR: pointer" height="11" src="../../../../Images/imgFlechas.gif" width="6" useMap="#img4" border="0">
					        ...
					        </MAP>&nbsp;<label id="lblNodo2" class="TBLINI" runat="server" style="height:auto; display:inline-table;">Nodo</label>&nbsp;
			...
			<div id="divCatalogo" style="OVERFLOW:auto; OVERFLOW-X:hidden; WIDTH:976px; HEIGHT:400px;" align="left" onscroll="scrollTablaProy()">
