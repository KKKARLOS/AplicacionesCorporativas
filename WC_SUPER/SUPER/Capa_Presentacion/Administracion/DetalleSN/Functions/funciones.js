...
function init(){
    try{
        ...
        switch(nNivel){
            case 1: $I("imgNivel").src = "../../../images/imgSN4.gif"; break;
            case 2: $I("imgNivel").src = "../../../images/imgSN3.gif"; break;
            case 3: $I("imgNivel").src = "../../../images/imgSN2.gif"; break;
            case 4: $I("imgNivel").src = "../../../images/imgSN1.gif"; break;
        }
    ...
    if (aResul[1] != "OK"){
        ...
        switch (aResul[0]){
           ...
           case "grabar":
                ...
                setOp($I("btnTrasladar"), 100);
                setOp($I("btnTrasladarPlus"), 100);
...
function comprobarDatos(){
    try{
        switch(nNivel){
            case 2:
                if ($I("hdnIDSN4").value == "") {
                    ...
                    mmoff("War", sSN4 + " es dato obligatorio.",320);
                    return false;
                }
                break;
            case 3:
                if ($I("hdnIDSN3").value == ""){
                    tsPestanas.setSelectedIndex(0);
                    mmoff("War", sSN3 + " es dato obligatorio.", 320);
                    return false;
                }
                break;
            case 4:
                if ($I("hdnIDSN2").value == ""){
                    tsPestanas.setSelectedIndex(0);
                    mmoff("War", sSN2 + " es dato obligatorio.", 320);
                    return false;
                }
                break;
        }
        ...
        if ($I("txtCualificador").value == ""){
            tsPestanas.setSelectedIndex(0);
            mmoff("War", "La denominación del \"Cualificador de proyecto\" es dato obligatorio",440);
            return false;
        }
...
function grabarP0(){
    ...
    switch(nNivel){
        case 1: sb.Append("0##"); break; //5
        case 2: sb.Append($I("hdnIDSN4").value +"##"); break; //5
        case 3: sb.Append($I("hdnIDSN3").value +"##"); break; //5
        case 4: sb.Append($I("hdnIDSN2").value +"##"); break; //5
    }
    sb.Append(nNivel +"##"); //6
    sb.Append(Utilidades.escape($I("txtCualificador").value) +"##"); //7
    sb.Append(($I("chkCualifObl").checked == true) ? "1##" : "0##"); //8
    sb.Append(($I("chkQEQ").checked == true) ? "1" : "0"); //9
    //}
    return sb.ToString();
}
function grabarP1(){
...
function aG(iPestana){//Sustituye a activarGrabar
    try{
            ...
            setOp($I("btnTrasladar"), 30);
            setOp($I("btnTrasladarPlus"), 30);    
...
function setOpcionAlertas(nOpcion) {
    try {
        var sMsg = "";
        switch (nOpcion) {
            case 1: sMsg = "Pulsa \"Aceptar\" para trasladar la configuración de las alertas del item actual, a los elementos del siguiente nivel de la estructura."; break;
            case 2: sMsg = "Pulsa \"Aceptar\" para trasladar la configuración de las alertas del item actual, a los elementos de todos los niveles inferiores de la estructura."; break;
        }
