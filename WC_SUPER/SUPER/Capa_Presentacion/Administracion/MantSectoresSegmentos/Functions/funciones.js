    ...
    $("#tree").fancytree({
        ...
        switch (data.cmd) {
            ...
            case "remove":
                ...
                jqConfirm("", "¡ Atención !<br>Se procederá al borrado del " + sElemento + " seleccionado.<br>¿Deseas continuar?", "", "", "war", 400).then(function (answer) {
                    if (!answer) return;
                    else
                    {
                        var o = new Object();
    ...
    */
    $("#tree").contextmenu({
      ...
      { title: "Borrar", cmd: "remove", uiIcon: "ui-icon-trash" },
        //{ title: "--------", cmd: "sep1", uiIcon: "ui-icon-plus" },
      {title: "Nuevo nodo", cmd: "addChild", uiIcon: "ui-icon-plus" },
        //{ title: "--------", cmd: "sep2", uiIcon: "ui-icon-plus" },
      ...
      { title: "Pegar", cmd: "paste", uiIcon: "ui-icon-clipboard", disabled: true }
        ...
        beforeOpen: function(event, ui) {
            ...
            if (node.data.nivel == "0") {
                ...
                //$("#tree").contextmenu("showEntry", "sep1", false);
                $("#tree").contextmenu("showEntry", "addChild", true);
                //$("#tree").contextmenu("showEntry", "sep2", false);
                ...
                //$("#tree").contextmenu("showEntry", "sep1", true);
                $("#tree").contextmenu("showEntry", "addChild", true);
                //$("#tree").contextmenu("showEntry", "sep2", true);
