<%@ Page Language="C#" MasterPageFile="~/MasterPages/Plantilla.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="MantSectoresSegmentos" Title="Untitled Page" %>
...
<br />
    ...
    <div id="divCatalogo" style="width: 556px; height:480px;overflow-y:auto;overflow-x:hidden;text-align:left;">
...
<br />
<table id="tblBotonera" style="width:260px; height:30px; margin-top:10px" border="0">
<colgroup>
	...
	<td>
		<button id="btnExpandir" type="button" class="btnH25W110" hidefocus="hidefocus" 
				...
				<img src="../../../images/botones/arrow_out.png" /><span>Expandir</span>
		</button>	 	
	</td>
	<td>    
		<button id="btnContraer" type="button" class="btnH25W110" hidefocus="hidefocus" 
				 onmouseover="se(this, 25);mostrarCursor(this);">
				<img src="../../../images/botones/arrow_in.png" /><span>Contraer</span>
		</button>		    
    </td> 
    </tr>     
</table>	
