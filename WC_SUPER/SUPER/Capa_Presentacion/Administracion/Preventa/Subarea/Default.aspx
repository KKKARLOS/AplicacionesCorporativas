...
<head runat="server">
<base target="_self" />
   <title> ::: SUPER ::: - Detalle de subárea preventa</title>
		    ...
		    <eo:MultiPage runat="server" id="mpContenido" CssClass="FMP" Width="100%" Height="450px">
		        ...
		        <eo:PageView CssClass="PageView" runat="server" align="center">
                    <fieldset style="width: 620px; margin-top:10px; margin-left:10px;">
                        ...
                        <tr>
                            <td><asp:Label ID="lblUnidad" runat="server" SkinID="enlace" onclick="getItemEstructura(21)" Text="Unidad" /></td>
                            <td><asp:TextBox ID="txtUnidad" style="width:500px; " Text="" readonly="true" runat="server" /></td>
                        </tr>
                        <tr>
                            <td><asp:Label ID="lblArea" runat="server" SkinID="enlace" onclick="getItemEstructura(22)" Text="Área" /></td>
                            <td><asp:TextBox ID="txtArea" style="width:500px; " Text="" readonly="true" runat="server" /></td>
                        </tr>
                        </table>
                     </fieldset> 
                    <table style="width:940px; margin-left:10px; margin-top:20px;" cellpadding="4px" class="texto">
                        <colgroup>
                            <col style="width:100px;" />
                        ...
                        <tr>
                            ...
                            <td colspan="2"><asp:TextBox ID="txtID" style="width:50px;visibility:hidden;" Text="" readonly="true" SkinID="Numero" runat="server" /></td>
                        </tr>
                        <tr>
                        </tr>
                        <tr style="vertical-align:middle;">
                            <td>Denominación</td>
                            <td colspan="2"><asp:TextBox ID="txtDenominacion" runat="server" style="width:500px;" MaxLength="50" Text="" onChange="aG(0);" /></td>
                        </tr>
                        <tr>
	                        <td><label id="lblResponsable" class="enlace" style="cursor:pointer;height:17px" onclick="getResponsable()">Responsable</label></td>
                            <td colspan="2"><asp:TextBox ID="txtDesResponsable" style="width:500px;" Text="" readonly="true" runat="server" /></td>
                        </tr>
                        <tr>
                            <td>Activa</td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td colspan="2">Permitir autoasignación de líder
                            </td>
                            <td>
                                <asp:CheckBox ID="chkLider" runat="server" Text="" style="cursor:pointer;" onclick="aG(0);" checked="true" />
                            </td>
                        </tr>
                    </table>
                    <br />
                    ...
                    <br />
                    <asp:TextBox ID="hdnIdSubArea" style="width:5px; visibility:hidden;" Text="" readonly="true" runat="server" />
                </eo:PageView>
						            ...
						            <legend class="Tooltip" title="Pinchar y arrastrar">Selector de figuras</legend>
         				            <div id="listOfItems" style="height:50px;">
                                        <ul id="allItems" style="width:265px;">
                                            ...
                                            <li id="L" value="3" onmouseover="mcur(this)" ><img src="../../../../Images/imgUsuLider.gif" onmouseover="mcur(this)" title="Invitado" ondragstart="return false;" /> Posible líder</li>
                                        </ul>
                                    </div>
                                    </fieldset>
	                            </td>
...
<table id="tblBotones" style="margin-top:15px; margin-left:40px; width:80%">
<tr>
