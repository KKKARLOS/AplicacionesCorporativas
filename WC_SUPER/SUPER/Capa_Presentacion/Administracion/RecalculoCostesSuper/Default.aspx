	                ...
	                <tr>
	                    <td colspan="2" align="center">
						    <button id="btnObtener" type="button" onclick="cargar();" class="btnH25W95" runat="server" hidefocus="hidefocus" onmouseover="mcur(this)">
                                ...
                                <span title="Añade los elementos indicados por el usuario a la tabla de recálculo de costes (T609_RECALCULOCOSTES)">&nbsp;Cargar</span>
						    </button>	   
	                    </td>
	                </tr>
                    <tr>
                        <td>Nº de filas en <label id="lblTabla" class="texto">T609_RECALCULOCOSTESSUPER</label>:</td>
    ...
    <TR>
	    <td colspan="3" align="left">
		    ...
		    <table style="margin-top:5px; width:950px;height:17px;">
			    ...
			    <tr class="TBLINI">
			        <TD style="text-align:right;padding-right:10px;">Cód. SUPER</TD>
			        <TD>Profesional</TD>
			        <TD>Error</TD>
			    </tr>
		    </table>
