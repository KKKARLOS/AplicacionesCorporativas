...
<table class="texto" id="Table1" style="width:990px;">
    <tr>
        <td style="vertical-align:top;">
            <table class="texto" style="width:970px; text-align:left;" cellpadding="5px" border="0">
                <colgroup><col style="width:500px;" /><col style="width:50px;" /><col style="width:420px;" /></colgroup>
                <tr>
                    <td>
                        <fieldset style="width:480px;">
	                        <legend>Usuario de referencia</legend>
                            <table class="texto" style="width:460px; text-align:left;">
	                                ...
	                                <td>
                                        <table style="width:460px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" id="chkSoloActivos" class="check" style="cursor:pointer;" title="Sólo activos" onclick="borrarCatalogo()"/>
                                                    <label id="lblSoloActivos" style="cursor:pointer; vertical-align:bottom;" onclick="chkSoloActivos.click();">Mostrar bajas</label>                                  
                                                </td>                                    
                                            </tr>
                                        </table>
	                                </td>
                    ...
                    <td></td>
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0" class="texto" width="400px">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td background="../../../Images/Tabla/5.gif" style="padding: 5px">
                                    ...
                                    <br />
                                        <h3>Al procesar se copiarán los siguientes permisos:</h3>
                                        <br />
                                        <span>
                                            <ul style="list-style-type:square; padding-left:20px;">
                                                <li>Figuras en la estructura organizativa</li>
                                                    <ul style="list-style-type:circle; padding-left:20px;">
                                                        <li>Área de negocio</li>
                                                        <li>Centro de responsabilidad</li>
                                                        <li>Línea de negocio</li>
                                                        <li>Negocio</li>
                                                        <li>Supernodo nivel 3</li>
                                                        <li>Supernodo nivel 4</li>
                                                     </ul>
                                                <li>Figuras de contrato</li>
                                                <li>Figuras de cliente</li>
                                                <li>Figuras de horizontal</li>
                                                <li>Figuras de cualificadores</li>
                                                <li>Figuras de proyecto (no incluye la responsabilidad de proyecto)</li>
                                                <li>Oficina técnica</li>
                                                <li>Pool de elementos de estructura técnica (PT, Fase y Actividad)</li>
                                                <li>Responsabilidad técnica en PTs</li>
                ...
                <table class="texto" style="width:970px; text-align:left;" cellpadding="5px">
                    ...
                    <tr>
                        ...
                        <td><!-- Técnicos asignados -->
                            ...
                            <div id="divCatalogo2" style="overflow: auto; overflow-x: hidden; width:456px; height:160px" target="true" onmouseover="setTarget(this);" caso="3" onscroll="scrollTablaProfAsig()">
                                <div style='background-image:url(../../../../Images/imgFT20.gif); width:440px; height:auto'>
