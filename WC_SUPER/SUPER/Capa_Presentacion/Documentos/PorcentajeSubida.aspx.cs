...
namespace SUPER
{
    public partial class PorcentajeSubida : System.Web.UI.Page
    {
        ...
        {
            if (Session["nRefrescos"] == null) Session["nRefrescos"] = 0;
            else Session["nRefrescos"] = (int)Session["nRefrescos"] + 1;

            if (Session["bArchivoExistente"] == null) Session["bArchivoExistente"] = false;
            ...
            {
                Session["bArchivoExistente"] = true;
            ...
            else if ((int)Session["nRefrescos"] > 2 && (bool)Session["bArchivoExistente"] == false)
            {
                Session[uploadIsReadyKey] = null;
                Session["oldLength"] = null;
                Session["nRefrescos"] = null;
                Session["bArchivoExistente"] = null;
                Response.Write("<script language='javascript'>window.close();</script>");
            }
        }
    }
