<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getPreferenciaMantCM.aspx.cs" Inherits="getPreferenciaMantCM" %>
    ...
    function setDefecto(objChk){
	    try{
            ...
            for (var i=0; i<tblDatos.rows.length; i++){
                if (tblDatos.rows[i].cells[4].children[0] == objChk){
                    if (tblDatos.rows[i].cells[4].children[0].checked == false){
                        tblDatos.rows[i].cells[4].children[0].checked = true;
                        window.focus();
                        return;
                    }
                    tblDatos.rows[i].cells[4].children[0].checked = true;
                    ...
                    if (tblDatos.rows[i].cells[4].children[0].checked == true)
                        fm(tblDatos.rows[i]);
                    tblDatos.rows[i].cells[4].children[0].checked = false;   
                }
            }
            window.focus();
        }catch(e){
        ...
        try{
            ...
            for (var i=0; i<aFila.length; i++){
                if (aFila[i].getAttribute("bd") != ""){
                    ...
                    sb.Append((aFila[i].cells[4].children[0].checked == true) ? "1##" : "0##"); //Defecto
...
<ucproc:Procesando ID="Procesando" runat="server" />
    ...
    <table style="width:570px; margin-left:10px;" cellpadding="5px">
        <tr>
            <td>
                <table style="WIDTH: 550px; HEIGHT: 17px;">
                    ...
                    <tr class="TBLINI">
				        ...
				        <td style='padding-left:3px;'>Área de análisis</td>
                ...
                <table style="WIDTH:550px; HEIGHT:17px;" cellpadding="0">
                    <tr class="TBLFIN">
                        <td></td>
                    </tr>
                </table>
