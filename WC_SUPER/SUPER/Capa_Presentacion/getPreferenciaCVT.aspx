<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getPreferenciaCVT.aspx.cs" Inherits="getPreferencia" %>
...
<head id="Head1" runat="server">
	...
	<!--
	    ...
	    function mostrarMantenimiento() {
	        try {
	            mostrarProcesando();
	            var strEnlace = strServer + "Capa_Presentacion/getPreferenciaMant.aspx?nP=" + codpar(nPantalla) + "&CV=S";
	            //window.focus();
