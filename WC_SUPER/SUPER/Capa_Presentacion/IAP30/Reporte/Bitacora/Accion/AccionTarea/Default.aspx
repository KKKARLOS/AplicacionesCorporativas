<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_Reporte_Bitacora_Accion_AccionTarea_Default" %>
    ...
    <div class="container-fluid ocultable">
        <div class="ibox-content blockquote blockquote-info">
            <div class="panel-group">
                <div>
                    <h1 class="sr-only">::: SUPER ::: - Creación de una acción para tarea</h1>  
                    <div id="content">
