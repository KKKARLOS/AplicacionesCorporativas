$(document).ready(function () { SUPER.IAP30.BitacoraAccionPE.app.init(); })

var SUPER = SUPER || {};
SUPER.IAP30 = SUPER.IAP30 || {};
SUPER.IAP30.BitacoraAccionPE = SUPER.IAP30.BitacoraAccionPE || {}

SUPER.IAP30.BitacoraAccionPE.app = (function (view) {
    ...
    grabarDatos = function (e) {
        if (comprobarDatosGrabar()) {
            ...
            var DatosGenerales = {
                t383_idaccion: parseInt(IB.vars.idAccion),
                t383_desaccion: view.dom.desAccion.val(),
                t382_idasunto: parseInt(IB.vars.idAsunto),
                t382_desAsunto: view.dom.desAsunto.val(),
                t383_desaccionlong: view.dom.descripcion.val(),
                t383_avance: view.dom.avance.find('option:selected').text(),
                t383_ffin: cadenaAfecha(view.dom.fechaFinalizacion.val()),
                t383_flimite: cadenaAfecha(view.dom.fechaLimite.val()),
                t383_obs: view.dom.observaciones.val(),
                t383_dpto: view.dom.departamento.val(),
                t383_alerta: view.dom.alerta.val(),
                t382_responsable: IB.vars.idResponsable,
            ...
            $.each($(view.selectores.filasProfesionalesSel), function () {
                //if ($(this).attr("data-bd") != "") {//Solo se actualizan filas modificadas
                    ...
                    oIntegrante.T383_idaccion = parseInt(IB.vars.idAccion   );
                    oIntegrante.T389_notificar = ($(this).children().eq(1).children().eq(0).is(':checked') == true) ? true : false;
            ...
            $.each($(view.selectores.filasTareas), function () {
                if ($(this).attr("data-bd") != "") {//Solo se actualizan filas modificadas
                    ...
                    oTarea.t382_idasunto = parseInt(IB.vars.idAsunto);
                    oTarea.t383_idaccion = parseInt(IB.vars.idAccion);
    ...
    function initPluginDocumentacion() {
        ...
        $.when(SUPER.IAP30.appDocumentos.initModuloDoc(_idDoc, "detalleAccionPE", _modoContainerDocs, IB.vars.codUsu, _soySuperEditor))
           .then(function () {
...
})(SUPER.IAP30.BitacoraAccionPE.View);