<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_Reporte_BitacoraT_Default" %>
...
<body>
   ...
   <div class="container-fluid">
        <h1 class="hiddenStructure">::: IAP 3.0 ::: Bitácora de tarea</h1>  
        <br class="visible-xs" />
		            ...
		            <div class="panel-group">
                        <form id="frmDatos" class="form-horizontal" runat="server">                    
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-12 col-md-11 no-padding">
                                    <div class="col-xs-12 col-md-10">
                                        <input id="fase" name="fase" class="form-control input-md" type="text" readonly="readonly" aria-readonly="true" value="" runat="server"/>
                                    </div>  
                                </div>  
                            </div>  
                            <br class="visible-xs" />
                            <div class="form-group row">	
                                ...
                                <div class="col-xs-12 col-md-11 no-padding">
                                    <div class="col-xs-12 col-md-10">
                                        <input id="actividad" name="actividad" class="form-control input-md" type="text" readonly="readonly" aria-readonly="true" value=""  runat="server" />
                                    </div>  
                                </div>
                            </div>   
                            <br class="visible-xs" />
                            <div class="form-group row">
                                <div class="col-xs-3 col-md-2 col-lg-1">			
                                    <label for="idTarea" class="control-label inline">Tarea </label>
                                </div>
                                <div class="col-xs-12 col-md-11 no-padding">
                                    <div class="col-xs-5 col-sm-3 col-md-2 col-lg-2">
                                        <input id="idTarea" name="idTarea" class="form-control input-md" type="text" readonly="readonly" aria-readonly="true" value="" runat="server"/>
                                    </div>
                                    <div class="col-xs-12 col-md-8">
                                        <input id="tareaDes" name="tareaDes" class="form-control input-md" type="text" readonly="readonly" aria-readonly="true" value="" title="" runat="server"/>      
                                    </div>
                                </div>
                            </div>     
                            <br class="visible-xs" />
...
<script src="js/view.js?20180214" type="text/javascript"></script>
