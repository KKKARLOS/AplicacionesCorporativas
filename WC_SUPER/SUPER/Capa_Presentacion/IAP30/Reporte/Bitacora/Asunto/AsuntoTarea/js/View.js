...
SUPER.IAP30.BitacoraAsuntoTA.View = (function () {
    ...
    pintarDatosAsunto = function (oAsunto) {
        dom.idAsunto.val(accounting.formatNumber(oAsunto.T600_idasunto,0));
        dom.desAsunto.val(oAsunto.T600_desasunto);
        dom.descripcion.val(oAsunto.T600_desasuntolong);
        dom.esfuerzoPlanificado.val(accounting.formatNumber(oAsunto.T600_etp));
        dom.esfuerzoReal.val(accounting.formatNumber(oAsunto.T600_etr));

        if (oAsunto.T600_fcreacion != null) dom.fechaCreacion.val(moment(oAsunto.T600_fcreacion).format("DD/MM/YYYY"));
        if (oAsunto.T600_fnotificacion != null) dom.fechaNotificacion.val(moment(oAsunto.T600_fnotificacion).format("DD/MM/YYYY"));
        if (oAsunto.T600_flimite != null) dom.fechaLimite.val(moment(oAsunto.T600_flimite).format("DD/MM/YYYY"));
        if (oAsunto.T600_ffin != null) dom.fechaFinalizacion.val(moment(oAsunto.T600_ffin).format("DD/MM/YYYY"));


        //if (moment(oAsunto.T600_fcreacion).format("DD/MM/YYYY") != "01/01/0001") dom.fechaNotificacion.val(moment(oAsunto.T600_fcreacion).format("DD/MM/YYYY"));
        //if (moment(oAsunto.T600_fnotificacion).format("DD/MM/YYYY") != "01/01/0001") dom.fechaNotificacion.val(moment(oAsunto.T600_fnotificacion).format("DD/MM/YYYY"));
        //if (moment(oAsunto.T600_flimite).format("DD/MM/YYYY") != "01/01/0001") dom.fechaLimite.val(moment(oAsunto.T600_flimite).format("DD/MM/YYYY"));
        //if (moment(oAsunto.T600_ffin).format("DD/MM/YYYY") != "01/01/0001") dom.fechaFinalizacion.val(moment(oAsunto.T600_ffin).format("DD/MM/YYYY"));

        dom.departamento.val(oAsunto.T600_dpto);
        dom.alerta.val(oAsunto.T600_alerta);
        dom.observaciones.val(oAsunto.T600_obs);
        dom.refExterma.val(oAsunto.T600_refexterna);
        dom.sistema.val(oAsunto.T600_sistema);
        dom.estado.val(oAsunto.T600_estado);
        IB.vars.coEstadoAnterior = oAsunto.T600_estado;
        dom.prioridad.val(oAsunto.T600_prioridad);
        dom.severidad.val(oAsunto.T600_severidad);
        dom.tipo.val(oAsunto.t384_idtipo);
        dom.registrador.val(oAsunto.Registrador);
        dom.notificador.val(oAsunto.T600_notificador);
        dom.responsable.val(oAsunto.Responsable);
        IB.vars.idResponsable = oAsunto.T600_responsable;
        IB.vars.bCambios = 0;
        dom.desAsunto.focus();
    }
    ...
    function pintarProfesionalesAsunto(data) {
        ...
        $.each(data, function (index, item) {
            ...
            sNotificacion = (item.t604_notificar) ? "checked=true" : "";
    ...
    function pintarTablaCronologia(data) {
        ...
        $.each(data, function (index, item) {
            ...
            sFecha = item.t606_fecha;
            if (sFecha != "") sFecha = moment(item.t606_fecha).format("DD/MM/YYYY");
    ...
    var comprobarDatosGrabar = function () {
        ...
        if (sError == "") {
            if (parseInt(IB.vars.idAsunto) != -1) {
                if (dom.estado.find('option:selected').val() == 0) {
        ...
        //Alertas por e-mail
        if (dom.alerta.val() != "") {
            $.each($(dom.alerta).val().split(";"), function (i, item) {
        ...
        if (sError != "") {
            ...
            $.when(a).then(function () {
                ...
                switch (nError) {
                    case 1: dom.desAsunto.focus(); break;
                    case 2: dom.fechaNotificacion.focus(); break;
                    case 3: dom.estado.focus(); break;
                    case 5: dom.alerta.focus(); break;
                }
            });
            return false;
        }
