...
SUPER.IAP30.BitacoraAsuntoPE = SUPER.IAP30.BitacoraAsuntoPE || {}

SUPER.IAP30.BitacoraAsuntoPE.View = (function () {
    ...
    pintarDatosAsunto = function (oAsunto) {
        ...
        dom.descripcion.val(oAsunto.T382_desasuntolong);
        dom.esfuerzoPlanificado.val(accounting.formatNumber(oAsunto.T382_etp));
        dom.esfuerzoReal.val(accounting.formatNumber(oAsunto.T382_etr));

        //if (moment(oAsunto.T382_fcreacion).format("DD/MM/YYYY") != "01/01/0001") dom.fechaCreacion.val(moment(oAsunto.T382_fcreacion).format("DD/MM/YYYY"));
        //if (moment(oAsunto.T382_fnotificacion).format("DD/MM/YYYY") != "01/01/0001") dom.fechaNotificacion.val(moment(oAsunto.T382_fnotificacion).format("DD/MM/YYYY"));
        //if (moment(oAsunto.T382_flimite).format("DD/MM/YYYY") != "01/01/0001") dom.fechaLimite.val(moment(oAsunto.T382_flimite).format("DD/MM/YYYY"));
        //if (moment(oAsunto.T382_ffin).format("DD/MM/YYYY") != "01/01/0001") dom.fechaFinalizacion.val(moment(oAsunto.T382_ffin).format("DD/MM/YYYY"));

        if (oAsunto.T382_fcreacion != null) dom.fechaCreacion.val(moment(oAsunto.T382_fcreacion).format("DD/MM/YYYY"));
        if (oAsunto.T382_fnotificacion != null) dom.fechaNotificacion.val(moment(oAsunto.T382_fnotificacion).format("DD/MM/YYYY"));
        if (oAsunto.T382_flimite != null) dom.fechaLimite.val(moment(oAsunto.T382_flimite).format("DD/MM/YYYY"));
        if (oAsunto.T382_ffin != null) dom.fechaFinalizacion.val(moment(oAsunto.T382_ffin).format("DD/MM/YYYY"));

        dom.departamento.val(oAsunto.T382_dpto);
        dom.alerta.val(oAsunto.T382_alerta);
        dom.observaciones.val(oAsunto.T382_obs);
        dom.refExterma.val(oAsunto.T382_refexterna);
        dom.sistema.val(oAsunto.T382_sistema);
        dom.estado.val(oAsunto.T382_estado);
        IB.vars.coEstadoAnterior = oAsunto.T382_estado;
        dom.prioridad.val(oAsunto.T382_prioridad);
        dom.severidad.val(oAsunto.T382_severidad);
        dom.tipo.val(oAsunto.T384_idtipo);
        dom.registrador.val(oAsunto.Registrador);
        dom.notificador.val(oAsunto.T382_notificador);
        dom.responsable.val(oAsunto.Responsable);
        IB.vars.idResponsable = oAsunto.T382_responsable;
        IB.vars.bCambios = 0;
        dom.desAsunto.focus();
    }
    ...
    function pintarProfesionalesAsunto(data) {
        ...
        $.each(data, function (index, item) {
            ...
            sNotificacion = (item.T388_notificar) ? "checked=true" : "";
    ...
    function pintarTablaCronologia(data) {
        ...
        $.each(data, function (index, item) {
            ...
            sFecha = item.T385_fecha;
            if (sFecha != "") sFecha = moment(item.T385_fecha).format("DD/MM/YYYY");
