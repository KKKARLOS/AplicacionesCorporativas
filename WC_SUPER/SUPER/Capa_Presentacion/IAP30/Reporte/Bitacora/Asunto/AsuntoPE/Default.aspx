<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_Reporte_Bitacora_Asunto_AsuntoPE_Default" %>
    ...
    <div class="container-fluid">
        <div class="ibox-content blockquote blockquote-info">
            <div class="panel-group">
                <div>
                    <h1 class="sr-only">::: SUPER ::: - Creación de asunto para proyecto económico</h1>  
                    <div id="content">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-md-5">
                                                            <input id="txtRegistrador" name="txtRegistrador" class="form-control input-md col-md-4 margin-bottom-xs-sm-md" type="text" readonly="true" value="" />
                                                        </div>
