<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_Reporte_BitacoraPE_Default" %>
...
<head runat="server">
    ...
    <title>::: IAP 3.0 ::: Bitácora de proyecto económico</title>  
...
<body>
    ...
    <div class="container-fluid">
        <h1 class="hiddenStructure">::: IAP 3.0 ::: Bitácora de proyecto económico</h1>
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-xs-12 col-md-6">
						            <fieldset id="fieldsetTecnico" class="fieldset">
                                        <h2 class="hiddenStructure">Información sobre proyectos técnicos</h2>     
							            <legend class="fieldset"><span class="text-nowrap">Bitácoras de proyectos técnicos</span></legend>                            
                                         <div class="row">
                                             <div class="col-xs-12">	
                                                 <div class="table-responsive">
                                                    <table id="tablaPT" class="table" title="Proyectos técnicos relacionados">
                                                        <thead>
                                                            <tr>
                                                                <th data-type="String" class="cabecera centrado" style="width: 100%">Denominación</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="bodyPT"></tbody>
                                                    </table>
                                                   </div>
                                            </div>

                                            <div class="botonTabla pull-right" style="margin-right:20px;">                      
                                                <span id="accesoPT" role="link" aria-label="Acceso a bitácora de proyecto técnico" 
                                                    class="fa fa-arrow-right" title="Acceso a bitácora de proyecto técnico"></span>
                                            </div>
