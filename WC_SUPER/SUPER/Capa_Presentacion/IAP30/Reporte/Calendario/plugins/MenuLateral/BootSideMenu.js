(function ( $ ) {
	...
	$(document).on('click','.toggler', function(){
		/*Para mostrar el mes seleccionado en el calendario*/
	    $('#mes').html('Imputaciones a tareas de <b>' + $('#cal .selectMonth option:selected').html() + " " + $('#cal .selectYear option:selected').html() +'</b>');

	    //$('#mes').html('Imputaciones a tareas de <b>' + $('#cal .selectMonth option:selected').html() + " " + $('#cal #anno').html() +'</b>');
