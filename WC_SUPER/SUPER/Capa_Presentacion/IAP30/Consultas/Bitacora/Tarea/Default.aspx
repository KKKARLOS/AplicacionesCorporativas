<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_IAP30_Consultas_Bitacora_Tarea_Default" %>
...
<head runat="server">
    ...
    <title>::: SUPER ::: - Consulta de bitácoras de Tarea</title>    
...
<body>
    ...
    <div class="container-fluid ocultable">
        ...
        <h1 class="sr-only">::: SUPER ::: - Consulta de bitácoras de Tarea</h1>

        <div class="row">
            <h2 class="sr-only">Criterios de selección</h2>
            <div class="col-xs-12">
                <div class="form-group">
                    <label for="txtProy" class="col-xs-12 col-md-2 col-lg-1 control-label fk-label">Proyecto</label>
                ...
                <div class="form-group">
                    <label for="txtProyTec" class="col-xs-12 col-md-2 col-lg-1 control-label fk-label">P. técnico</label>
                    <div class="col-xs-12 col-md-10 col-lg-11">
                        <input id="txtProyTec" name="" type="text" class="form-control input-md" value="" disabled="disabled" aria-readonly="true" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="txtFase" class="col-xs-12 col-md-2 col-lg-1 control-label fk-label">Fase</label>
                    <div class="col-xs-12 col-md-10 col-lg-11">
                        <input id="txtFase" name="" type="text" class="form-control input-md" value="" disabled="disabled" aria-readonly="true" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="txtAct" class="col-xs-12 col-md-2 col-lg-1 control-label fk-label">Actividad</label>
                    <div class="col-xs-12 col-md-10 col-lg-11">
                        <input id="txtAct" name="" type="text" class="form-control input-md" value="" disabled="disabled" aria-readonly="true" />
                    </div>
                </div>
                <div class="form-group">
                    <label id="lblTarea" role="link" title="Selección de tarea" class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label fk-label txtLinkU" for="datosTarea">Nº Tarea</label>
					<div class="col-xs-4 col-xs-off-5 col-sm-2 col-md-2 col-lg-1">
						<input id="idTarea" name="idTarea" class="form-control input-md margin-bottom-xs-sm-md no-padding-right" aria-label="Identificador de tarea" type="text" value="" />
					</div>
                    <label for="desTarea" class="col-xs-12 col-md-2 col-lg-1 control-label fk-label">Descripción</label>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-3">
                <label class="col-xs-12 col-sm-1 col-md-1 col-lg-2 control-label fk-label" for="cboSeveridad">Severidad</label>
                <div class="col-xs-12 col-sm-11 col-md-11 col-lg-10">
...
<script src="<% =Session["strServer"].ToString() %>plugins/IB/buscatarea.js?20180102_01"></script>

<script src="js/view.js?20171214_23" type="text/javascript"></script>
