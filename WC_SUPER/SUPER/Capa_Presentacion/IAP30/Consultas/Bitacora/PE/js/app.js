...
SUPER.IAP30.Bitacora.PE.app = (function (view) {
    ...
    var obtenerFiltrosBitacora = function () {
        ...
        getElementos(view.dom.IdProyectoSubnodo.val(), bConAcciones, view.dom.txtDenominacion.val(),
    ...
    var mostrarDetalle = function (e) {
        ...
        var sParam = "&ori=IAP&p=L" + "&nPSN=" + view.dom.IdProyectoSubnodo.val() + "&txtProy=" + view.dom.txtPro.val() + "&denom=" + view.dom.txtDenominacion.val();
        if (view.dom.chkConAcciones.is(":checked")) {
            sParam += "&conACC=S";
        }
        else
    ...
    var getElementos = function (idPSN, bConAcciones, Denominacion,
                                 TipoAsunto, Estado, Severidad, Prioridad,
                                 dNotif, hNotif, dLimite, hLimite, dFin, hFin) {
        ...
        var payload = {
            idPSN: idPSN, acciones: bConAcciones, Denominacion: Denominacion,
