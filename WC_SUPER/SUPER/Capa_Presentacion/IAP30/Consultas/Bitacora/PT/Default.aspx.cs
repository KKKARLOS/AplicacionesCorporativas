...
public partial class Capa_Presentacion_IAP30_Consultas_Bitacora_PT_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                this.txtPT.Value = ht["desPT"].ToString();
                this.hdnIdPT.Value = ht["nPT"].ToString();
            }
    ...
    public static List<Models.Bitacora> getElementos(int idPT, bool acciones, string Denominacion,
                                                                    ...
                                                                    )
    {
        ...
        try
        {
            ...
            lBitacora = BitacoraBLL.CatalogoPT(idPT, acciones, Denominacion, TipoAsunto, Estado, Severidad, Prioridad,
