<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_IAP30_Consultas_Bitacora_PT_Default" %>
...
<head runat="server">
    ...
    <title>::: SUPER ::: - Consulta de bitácoras de Proyecto Técnico</title>    
...
<body>
    ...
    <div class="container-fluid ocultable">
        ...
        <h1 class="sr-only">::: SUPER ::: - Consulta de bitácoras de Proyecto Técnico</h1>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4">
                <div class="col-xs-12 col-md-3">
                    <label id="lblPT" title="Selección de proyecto técnico" role="link" class="control-label fk-label btn-link txtLinkU">PT</label><span class="text-danger"> *</span>
                    </div>   
                <div class="col-xs-12 col-md-8">
                    <input id="txtPT" name="" type="text" class="form-control input-md fk_filtro" value="" aria-required="true" required="required" runat="server" />
                </div>
            </div>
            <div class="col-xs-12 col-sm-4">
                <label for="txtDenominacion" class="col-xs-12 col-sm-4 col-md-3 col-lg-2 control-label fk-label">Denominación</label>
    ...
    <!-- Modal de selección de proyecto tecnico -->
    <div class="fk_ayudaPT"></div>

    <input type="hidden" name="hdnIdProyectoSubNodo" id="hdnIdProyectoSubNodo" value="" runat="server" /> 
    <input type="hidden" name="hdnIdPT" id="hdnIdPT" value="" runat="server" /> 
    </body>
...
<script src="<% =Session["strServer"].ToString() %>plugins/IB/buscaproyecto.js?20171227_01" type="text/javascript"></script>
<script src="<% =Session["strServer"].ToString() %>plugins/IB/buscacatalogobasico.js?20171229_02"></script>

<script src="js/view.js?20171229_01" type="text/javascript"></script>
<script src="js/app.js?20171229_01" type="text/javascript"></script>
