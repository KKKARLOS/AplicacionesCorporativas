...
function aceptarClick(oCelda){
    try{
        ...
        var oFila = oCelda.parentNode;
        var nPos = (ie) ? oFila.cells[0].children[2].innerText.indexOf(" - ") : oFila.cells[0].children[2].textContent.indexOf(" - ");
        var sCadena = "";
        if (ie) sCadena = oFila.cells[0].children[2].innerText.substring(nPos + 3, oFila.cells[0].children[2].innerText.length);
        else sCadena = oFila.cells[0].children[2].textContent.substring(nPos + 3, oFila.cells[0].children[2].textContent.length);
        
        var returnValue = oFila.getAttribute("PSN") +"///"+
                             oFila.getAttribute("PT") + "///" +
                             oFila.getAttribute("T") + "///" + 
                             sCadena + "///"+
                             oFila.getAttribute("ImpFes") + "///" +
                             oFila.getAttribute("NOJC") + "///" +
                             oFila.getAttribute("Obligaest"); /* +"///"+ 
                            oFila.ete +"///"+ 
                            oFila.ffe +"///"+ 
                            oFila.Comentario;*/
