...
(function ($) {
    if ($.fn.ajaxForm == undefined) {
        ...
        $.getScript(IB.vars.strserver + "plugins/jqueryuploadfile/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var uploadLabel = $('<span class="btn btn-primary btn-sm">' + s.uploadStr + '</span>');
        ...
        function defaultProgressBar(obj, s) {
            ...
            this.cancel = $("<span class='fa fa-trash'></span>").appendTo(this.statusbar).hide();
