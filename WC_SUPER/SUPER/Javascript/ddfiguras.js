...
function initDrag(e)	// Mouse button is pressed down on a LI
{
	...
	if (getNextElementSibling(this)) {
	    ...
	    contentToBeDragged_next = getNextElementSibling(this);

	    //if (!this.tagName && contentToBeDragged_next.nextSibling) contentToBeDragged_next = contentToBeDragged_next.nextSibling;
	    if (!this.tagName && getNextElementSibling(contentToBeDragged_next)) contentToBeDragged_next = getNextElementSibling(contentToBeDragged_next);
