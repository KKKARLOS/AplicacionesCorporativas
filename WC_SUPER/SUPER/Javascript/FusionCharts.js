	...
	render: function(elementId){
		...
		if((this.detectFlashVersion==1) && (this.installedVer.major < 6)){
			if (this.autoInstallRedirect==1){
				...
				var installationConfirm = window.confirm("Para ver los gráficos es necesario disponer de Adobe Flash Player 6 (ó superior). La instalación es gratuíta y rápida desde Adobe.com. Por favor, pulse Ok para instalar.");
