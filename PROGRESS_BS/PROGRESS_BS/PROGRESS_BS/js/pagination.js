...
var Pagination = function (el, options) {
	...
	var $container = $(el),
		...
		allPagesLabel = options.labels.all || 'Todos',
		firstPageLabel = options.labels.first || 'Primero',
		lastPageLabel = options.labels.last || '&Uacute;ltimo',
	...
	getRenderedPageNumbers = function () {
		...
		result = '<li data-page="' + FIRST_PAGE_NUMBER + '"><a href="#"><span aria-hidden="true">' + firstPageLabel + '</span></a></li>' +
				 '<li data-page="' + PREVIOUS_PAGE_NUMBER + '"><a href="#"><span aria-hidden="true">' + previousPageLabel + '</span></a></li>';

		$.each(pageNumbers, function (i, p) {
		    result += '<li data-page="' + p + '" ' + (p === currentPage ? 'class="active"' : '') + '><a href="#">' + p + '</a></li>';
		});

		result += '<li data-page="' + NEXT_PAGE_NUMBER + '"><a href="#"><span aria-hidden="true">' + nextPageLabel + '</span></a></li>' +
				  '<li data-page="' + LAST_PAGE_NUMBER + '"><a href="#"><span aria-hidden="true">' + lastPageLabel + '</span></a></li>';
