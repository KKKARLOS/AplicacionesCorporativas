<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_Administracion_CuadroMandoCambioRol_SolicitudesAprobadasStandby_Default" %>
...
<head runat="server">
    ...
    <title>Solicitudes de aprobación pendientes de aceptación</title>
...
<body>
            ...
            <div class="col-xs-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="display: inline-block; margin-right: 15px">Solicitudes aprobadas en Stand by, pendientes de resolución de RRHH</h3>
                        (Nº de solicitudes:
                        ...
                        <table id="tablaSolicitudes" class="table header-fixed tablesorter">
                            <thead>
                                <tr>
                                    ...
                                    <th><span class="margenCabecerasOrdenables">Resolución</span></th>
                ...
                <div class="pull-right">
                    <button id="btnAceptar" type="button" class="btn btn-primary">Aceptar la aprobación de cambio de rol</button>
                    <button id="btnRechazar" type="button" class="btn btn-primary" style="margin-left: 7px;">Desestimar cambio de rol</button>
                </div>
            </div>
        </div>
    </form>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-primary">
				...
				<h4 class="modal-title">Desestimar la aprobación</h4>
			</div>
			<div class="modal-body">	
                
                <div class="well" id="divProfesionalesRechazados"></div>
                <span id="spanTexto">Pulsa el botón 'Aceptar' para desestimar la aprobación de cambios de rol para los profesionales indicados</span><hr />
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-primary">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Aceptar la aprobación de cambio de rol</h4>
			</div>
			<div class="modal-body">	
