...
//                                @page {margin: 2cm;}
            ...
            <body bgcolor='#f7fafb' scroll='auto' text='#000000' leftmargin='0' topmargin='0'>
				<table style='FONT-FAMILY: Arial;FONT-SIZE: 11px' width='100%' border='0' cellspacing='0' cellpadding='0'> 
                    ...
                    1.- El acceso a la información detallada de la factura no está disponible.<br>
                    ...
                    3.- En color <span style='color:blue'>Azul</span>, se recogen aquellas líneas de las que eres responsable pero que están asignadas a otro departamento/servicio o a un colaborador externo (Beneficiario).<br> 
                    4.- Para cualquier consulta, puedes contactar con <a href='mailto:cau@ibermatica.com' class='enlace'>CAU Ibermática</a><br>
...
//                                @page {margin: 2cm;}
        ...
        public static string CabeceraHtmlPropias()
        {
            ...
            sb.Append(@"<table class='texto2' id='tblTitulo' style='width:800px; margin-top:15px; padding-top:10px; padding-bottom:10px; height:17px; table-layout:fixed; border-collapse: collapse;' cellpadding='5px'>
                        <tr>
                            ...
                            <td style='width:95px;' class='bordeltb' align='center'><label class='negri'>Datos (Mbytes)</label></td>
                            <td style='width:45px;' class='bordes' align='center'><label class='negri'>Resto</label></td>
                            <td style='width:260px;' class='bordes' align='center'><label class='negri'>Beneficiario/Dpto</label></td>
                        </tr>
                        </table>");
        ...
        public static string CabeceraHtmlCola()
        {
            ...
            sb.Append(@"<table class='texto2' id='tblTitulo' style='width:800px; margin-top:15px; padding-top:10px; padding-bottom:10px; height:17px; table-layout:fixed; border-collapse: collapse;' cellpadding='5px'>
                        <tr>
                            <td style='width:260px;' align='center' class='bordeltb'><label class='negri'>Beneficiario</label></td>
                            <td style='width:65px;'  align='center' class='bordeltb'><label class='negri'>Pref/Nº Línea</label></td>
                            <td style='width:45px;'  align='center' class='bordeltb'><label class='negri'>NºExt.</label></td>
                            <td style='width:50px;'  align='center' class='bordeltb'><label class='negri'>Total</label></td>
                            <td style='width:60px;'  align='center' class='bordeltb'><label class='negri'>Móv.Nac.</label></td>
        ...
        public static string DestMailDesarrollo()
        {
            ...
            try
            {
                sTo = System.Configuration.ConfigurationManager.AppSettings["SMTP_to_DES"].ToString();
        ...
        public static string DestMailError()
        {
            ...
            try
            {
                sToError = System.Configuration.ConfigurationManager.AppSettings["SMTP_to"].ToString();
                if (System.Configuration.ConfigurationManager.ConnectionStrings["ENTORNO"].ToString() == "D")
                    sToError = System.Configuration.ConfigurationManager.AppSettings["SMTP_to_DES"].ToString();
        ...
        public static string RteMailError()
        {
            ...
            try
            {
                sRte = System.Configuration.ConfigurationManager.AppSettings["SMTP_from"].ToString();
