...
namespace GEMO.BLL
{
    ...
    {
        public static string Obtener(string t708_departamento, string sTipoBusqueda, Nullable<int> t001_idficepi)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("<table id='tblDatos' class='MAM' style='WIDTH: 350px;'>");
            sb.Append("<colgroup><col style='padding-left:5px;'></colgroup>");
            sb.Append("<tbody>");
            SqlDataReader dr = GEMO.DAL.DEPARTAMENTO.Catalogo(t708_departamento, sTipoBusqueda, t001_idficepi);
        ...
        public static string Obtener2(string sTS)
        {
            ...
            sb.Append("<colgroup><col style='padding-left:5px;'></colgroup>");
            sb.Append("<tbody>");
            SqlDataReader dr = GEMO.DAL.DEPARTAMENTO.Catalogo2();
            ...
            {
                i++;
                sb.Append("<tr id='" + i.ToString() + "' onclick=");
