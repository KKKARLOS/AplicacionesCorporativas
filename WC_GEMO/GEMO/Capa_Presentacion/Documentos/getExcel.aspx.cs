...
public partial class Capa_Presentacion_Documentos_getExcel : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=" + "GEMOExcel-" + Session["IDFICEPI_ENTRADA"].ToString() + ".xls");
        ...
        foreach (string sTabla in aTablas)
        {
            ...
            string sFichero = "GEMOExcel-" + Session["IDFICEPI_ENTRADA"].ToString() + "-" + DateTime.Now.Ticks.ToString() + ".htm";
