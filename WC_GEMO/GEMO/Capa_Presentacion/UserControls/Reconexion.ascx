<%@ Control Language="c#" Inherits="GEMO.Capa_Presentacion.UserControls.Reconexion" CodeFile="Reconexion.ascx.cs" %>
<STYLE type=text/css>
			...
			<P style="FONT-SIZE: 11px; PADDING-TOP: 0px">
				<table Border=0 CellPadding=1 CellSpacing=0 Width=100%>
					<TR><TD Width=4></TD>
						...
						IAP ha detectado que tiene más de un usuario activo.<br /><br />Por favor, reporte las horas con el usuario adecuado pinchando sobre el botón de reconexión.
						</TD>
					</TR>
				</TABLE>
			</P>
