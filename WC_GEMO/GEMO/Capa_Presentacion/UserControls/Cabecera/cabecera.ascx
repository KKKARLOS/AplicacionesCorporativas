<%@ Control Language="c#" Inherits="GEMO.Capa_Presentacion.UserControls.Cabecera.C_Cabecera" CodeFile="Cabecera.ascx.cs" %>
<asp:Table ID="tblCabecera" runat="server" BackImageUrl="~/Capa_Presentacion/UserControls/Cabecera/images/imgFondo.gif" 
 CellPadding="0" CellSpacing="0" Height="47px" Width="100%" BorderStyle="None" style="table-layout:auto;">
    ...
    <asp:TableRow ID="TableRow2" runat="server">
        ...
        <asp:TableCell ID="TableCell5" CssClass="UsuarioFecha" Width="100%" Height="14px" runat="server"><asp:Label ID="lblProfesional" style='OVERFLOW:hidden;TEXT-OVERFLOW:ellipsis' runat="server" Width="270px" /></asp:TableCell>
