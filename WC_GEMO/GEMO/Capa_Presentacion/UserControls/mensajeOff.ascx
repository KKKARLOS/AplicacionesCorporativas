<%@ Control Language="c#" Inherits="GEMO.Capa_Presentacion.UserControls.MensajeOff" CodeFile="mensajeOff.ascx.cs" %>
...
//                $I("popupWin_content").parentElement.style.left = (document.body.clientWidth/2) - nWidth/2;
//                $I("popupWin_content").parentElement.style.top = (document.body.clientHeight/2) -80;
//                $I("popupWin_content").parentElement.style.width = nWidth+6;
//                $I("popupWin_content").parentElement.style.height = (nHeight) ? nHeight+6 : 36;
...
//        }
        ...
        function mmoff(sTexto, nWidth, nTiempo, nHeight, nLeft, nTop){ 
            try{
                popupWinhideAfter = (nTiempo) ? nTiempo : 1500;
                $I("popupWin_content").parentElement.style.left =  (nLeft) ? nLeft : (document.body.clientWidth/2) - nWidth/2;
                //$I("popupWin_content").parentElement.style.top = (nTop) ? nTop : (document.body.clientHeight/2) -80;
                $I("popupWin_content").parentElement.style.top = (nTop) ? nTop : (document.body.clientHeight/2) - ((nHeight) ? nHeight+6 : 36);
                $I("popupWin_content").parentElement.style.width = nWidth + 6;
                $I("popupWin_content").parentElement.style.height = (nHeight) ? nHeight+6 : 36;
                $I("popupWin_content").style.width = nWidth;
                $I("popupWin_content").innerText = sTexto;
