...
function initDrag(e)	// Mouse button is pressed down on a LI
{
    ...
    if (cloneSourceItems && contentToBeDragged.parentNode.id == 'allItems') {
        ...
        if (newItem.id == "C" || newItem.id == "F" || newItem.id == "M" || newItem.id == "A" || newItem.id == "I") {
...
function dragDropEnd(e) {
    ...
    if (destinationObj.tagName == "UL" || destinationObj.tagName == "IMG" || destinationObj.tagName == "LI") {
        ...
        switch (destinationObj.tagName) {
            ...
            case "IMG":
                oUL = event.srcElement.parentElement.parentElement;
                if (event.srcElement.src.indexOf("imgControlador.gif") == -1
	                && event.srcElement.src.indexOf("imgFacturador.gif") == -1
                //	                && event.srcElement.src.indexOf("imgInteresado.gif") == -1
	                && event.srcElement.src.indexOf("imgMedios.gif") == -1
	                && event.srcElement.src.indexOf("imgAdministrador.gif") == -1
