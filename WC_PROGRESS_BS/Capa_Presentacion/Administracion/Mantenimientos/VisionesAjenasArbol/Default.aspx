<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Capa_Presentacion_Administracion_Mantenimientos_VisionesAjenasArbol_Default" %>
...
<body data-codigopantalla="416">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-4">
                <span id="leyenda">... puede ver evaluaciones de ...</span>
            </div>         
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-10 header col-xs-offset-1">
                <span class="pull-left" style="margin-left: 7px">Visualizador/a</span>
                <span id="txtHeaderVisualizados" class="pull-left hide" style="margin-left: 112px">Visualizados/as</span>
                <span id="txtHeaderAmbitoVision" class="pull-left hide" style="margin-left: 150px">Ámbito de visión</span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1">
                <div>
                    <button id="addVisualizador" class="btn btn-primary">Añadir visualizadores/as</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header btn-primary">
                    <h4 class="modal-title">Mantenimiento de visualizadores/as</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                       <div id="divEvaluador" runat="server" class="col-xs-10 fk-ocultar">
                                <button id="lblVisualizadorModal" class="btn btn-link" runat="server">Visualizador</button>
                                <span id="spanVisualizador" style="display:none">Visualizador</span>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary pull-left" id="mntVisualizados"  data-toggle="modal">Selección de visualizados/as</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-10 col-xs-offset-1">
                            <span>Si pulsas "Aceptar" se eliminará el profesional visualizador con todos sus visualizados</span>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
