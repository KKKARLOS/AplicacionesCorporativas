...
public partial class Capa_Presentacion_Administracion_Mantenimientos_VisionesAjenasArbol2_Default : System.Web.UI.Page
{
    ...
    public static List<IB.Progress.Models.VisionesAjenasArbol> catalogoVisionesAjenasArbol()
    {
        ...
        try
        {
            ...
            visionesAjenasArbol = dVisionesAjenasArbol.catalogoVisionesAjenasArbol2("B", null);
    ...
    public static void deleteVisualizador(int idficepiVisualizador)
    {
        try
        {
            ...
            cVision.Delete(idficepiVisualizador);
            cVision.Dispose();
    ...
    public static void GrabarDatos(List<IB.Progress.Models.VisionesAjenasArbol> oVisualizadores)
    {
        ...
        try
        {
            ...
            bllvision.MantenerCatalogo("B",oVisualizadores);
            bllvision.Dispose();
        }
        catch (Exception ex)
        {
    ...
    public static List<IB.Progress.Models.VisionesAjenasArbol> selVisualizados(int t001_idficepi_visualizador)
    {
        ...
        try
        {
            ...
            visionesAjenasArbol = dVisionesAjenasArbol.catalogoVisionesAjenasArbol2("B", t001_idficepi_visualizador);
            dVisionesAjenasArbol.Dispose();
