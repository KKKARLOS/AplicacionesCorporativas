...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="CustomerReportTemplateDTO">
    <wordDoc>
      <!--Sustituir-->
      <!-- Inicio cabecera-->
      <w:hdr xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:pic="http://schemas.openxmlformats.org/drawingml/2006/picture" xmlns:ve="http://schemas.openxmlformats.org/markup-compatibility/2006" 
            ...
            <w:tc>
              ...
              <w:p w:rsidRPr="00E83BF1" w:rsidR="00131405" w:rsidP="00724DBF" w:rsidRDefault="00131405">
                ...
                <w:r w:rsidRPr="00E83BF1">
                  ...
                  <w:t>Date of printing: </w:t>
					          <!--<w:t>
                      <xsl:value-of select="msxsl:current-dateTime()"/>
                    </w:t>-->
                </w:r>
                <!--<w:r>
                  <w:rPr>
  ...
  <xsl:template match="ReportTemplates/ReportTemplateDTO" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
    ...
    <xsl:if test="position()!=last()">
      <xsl:if test="PageBreakAfterTemplate='true'">
        <w:p w:rsidR="00131405" w:rsidRDefault="00131405" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" >
          <w:r>
            <w:br w:type="page" />
          </w:r>
        </w:p>
