...
values('ADELANTOSPRESCRIPCION','ADELANTOS DE PRESCRIPCION','ADELANTOS DE PRESCRIPCION',6,0,'',11,'','','44681293','44681293',
GETDATE(),GETDATE(),0,0,0,0,66,0,0,0,1,3,'44681293',GETDATE())

declare @id int
select @id=id from [Routine] where Code = 'ADELANTOSPRESCRIPCION'
