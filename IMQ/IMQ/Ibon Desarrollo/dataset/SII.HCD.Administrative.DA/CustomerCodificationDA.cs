...
namespace SII.HCD.Administrative.DA
{
    public class CustomerCodificationDA : DAServiceBase
    {
        ...
        public DataSet GetMDSCustomerCodification2(int maxRows, int[] processChartIDs,
        ...
        public DataSet GetMDSCustomerCodification(int maxRows, int[] processChartIDs, BasicProcessStepsEnum step, CommonEntities.StatusEnum status, int[] locations, int[] careCenterIDs, int assistanceServiceID,
            DateTime? startDateTime, DateTime? endDateTime, string transferReason, MixedCodificationStatusEnum codificationStatus)
        {
            ...
            try
            {
                ...
                ds.Tables.Add("CustomerCodification");
                ds.Tables["CustomerCodification"].Load(dr);
