...
namespace SII.HCD.Administrative.DA
{
    public class CustomerCodificationDA : DAServiceBase
    {
        ...
        public DataSet GetMDSCustomerCodification1(int maxRows, int[] processChartIDs,
        ...
        public List<List<object>> GetMDSCustomerCodification(int maxRows, int[] processChartIDs, BasicProcessStepsEnum step, CommonEntities.StatusEnum status, int[] locations, int[] careCenterIDs, int assistanceServiceID,
            DateTime? startDateTime, DateTime? endDateTime, string transferReason, MixedCodificationStatusEnum codificationStatus)
        {
            IDataReader dr = null;
            ...
            try
            {
                ...
                cDblib.CommandTimeout = 0;

                DataTable dtProcessChartIDs = cDblib.ConvDTInt(processChartIDs);
                DataTable dtLocations = cDblib.ConvDTInt(locations);
                DataTable dtCareCenterIDs = cDblib.ConvDTInt(careCenterIDs);

                SqlParameter[] dbparams = new SqlParameter[10] {
                    Param(enumDBFields.Step, step),
                    Param(enumDBFields.Status, status),
                    Param(enumDBFields.AssistanceService, assistanceServiceID),
                    Param(enumDBFields.CodificationStatus, codificationStatus),
                    Param(enumDBFields.TransferReason, transferReason),
                    Param(enumDBFields.StartDateTime, startDateTime),
                    Param(enumDBFields.EndDateTime, endDateTime),
                    Param(enumDBFields.TVPProcessChartIDs, dtProcessChartIDs),
                    Param(enumDBFields.TVPLocations, dtLocations),
                    Param(enumDBFields.TVPCareCenterIDs, dtCareCenterIDs),
                };

                dr = cDblib.DataReader("GetMDSCustomerCodification", dbparams);
                ...
                while (dr.Read())
                {
                    ...
                    datos.Add(dr["CustomerProcessID"]);
                    datos.Add(dr["ProcessChartID"]);
                    datos.Add(dr["CareCenterID"]);
                    datos.Add(dr["CustomerCodificationID"]);
                    datos.Add(dr["CustomerEpisodeID"]);
                    datos.Add(dr["CustomerLeaveID"]);
                    datos.Add(dr["CustomerID"]);
                    datos.Add(dr["PersonID"]);
                    datos.Add(dr["CareCenterName"]);
                    datos.Add(dr["ProcessChartName"]);
                    datos.Add(dr["EpisodeTypeName"]);
                    datos.Add(dr["CHNumber"]);
                    datos.Add(dr["Sex"]);
                    datos.Add(dr["FirstName"]);
                    datos.Add(dr["LastName"]);
                    datos.Add(dr["LastName2"]);
                    datos.Add(dr["BirthDate"]);
                    datos.Add(dr["DeathDateTime"]);
                    datos.Add(dr["DeathDateTime"]);
                    datos.Add(dr["CustomerEpisodeNumber"]);
                    datos.Add(dr["CustomerEpisodeDate"]);
                    datos.Add(dr["EpisodeReason"]);
                    datos.Add(dr["AssistanceService"]);
                    datos.Add(dr["Origin"]);
                    datos.Add(dr["CustomerEpisodeEndDate"]);
                    datos.Add(dr["EpisodeLeaveReason"]);
                    datos.Add(dr["DischargeAssistanceService"]);
                    datos.Add(dr["DischargeFacilityName"]);
                    datos.Add(dr["CustomerCodificationStatus"]);
                    datos.Add(dr["PrimaryDiagnosis"]);
                    datos.Add(dr["HasOtherDiagnosis"]);
                    datos.Add(dr["IncludePreviousEpisodes"]);
                    datos.Add(dr["HasMorphologies"]);
                    datos.Add(dr["HasSurgicalProcedures"]);
                    datos.Add(dr["HasObstetricProcedures"]);
                    datos.Add(dr["HasOtherProcedures"]);
                    datos.Add(dr["PrimaryMDC"]);
                    datos.Add(dr["HasOtherMDCs"]);
                    datos.Add(dr["PrimaryDRG"]);
                    datos.Add(dr["HasOtherDRGs"]);
                    datos.Add(dr["PrimaryDRGWeight"]);
                    datos.Add(dr["RelatedCost"]);
                    datos.Add(dr["Explanation"]);
                    datos.Add(dr["RegistrationDateTime"]);
                    datos.Add(dr["ConfirmedDateTime"]);
                    datos.Add(dr["ExportedDateTime"]);
        ...
        private IB.sqldblib.SqlServerSP cDblib = null;
        private bool disposed = false;

        private Guid classOwnerID = new Guid("a695f58d-9f3f-4206-b00c-9783a9263a87");
        ...
        private enum enumDBFields : byte
        {
            ...
            Status = 2,
            AssistanceService = 3,
            CodificationStatus = 4,
            TransferReason = 5,
            StartDateTime = 6,
            EndDateTime = 7,
            TVPProcessChartIDs = 8,
            TVPLocations = 9,
            TVPCareCenterIDs = 10,
        }
        ...
        {
            if (cDblib == null) cDblib = new IB.sqldblib.SqlServerSP("server=HCDISBEFE;database=HCDIS_OPT;uid=sa;pwd=pass@word1;Trusted_Connection=no;app=SQLDBLIBIBON;", classOwnerID);
        }
        public void Dispose()
        {
            Dispose(true);
        ...
        private SqlParameter Param(enumDBFields dbField, object value)
        {
            ...
            switch (dbField)
            {
                case enumDBFields.Step:
                    paramName = "@Step"; paramType = SqlDbType.Int; paramSize = 4; break;
                case enumDBFields.Status:
                    paramName = "@Status"; paramType = SqlDbType.Int; paramSize = 4; break;
                case enumDBFields.AssistanceService:
                    paramName = "@AssistanceService"; paramType = SqlDbType.Int; paramSize = 4; break;
                case enumDBFields.CodificationStatus:
                    paramName = "@CodificationStatus"; paramType = SqlDbType.Int; paramSize = 4; break;
                case enumDBFields.TransferReason:
                    paramName = "@TransferReason"; paramType = SqlDbType.NVarChar; paramSize = 8; break;
                case enumDBFields.StartDateTime:
                    paramName = "@StartDateTime"; paramType = SqlDbType.DateTime; paramSize = 8; break;
                case enumDBFields.EndDateTime:
                    paramName = "@EndDateTime"; paramType = SqlDbType.DateTime; paramSize = 8; break;
                case enumDBFields.TVPProcessChartIDs:
                    paramName = "@TVPProcessChartIDs"; paramType = SqlDbType.Structured; paramSize = 8; break;
                case enumDBFields.TVPLocations:
                    paramName = "@TVPLocations"; paramType = SqlDbType.Structured; paramSize = 8; break;
                case enumDBFields.TVPCareCenterIDs:
                    paramName = "@TVPCareCenterIDs"; paramType = SqlDbType.Structured; paramSize = 8; break;
