    ...
    public class CustomerCodificationBL : CustomerProcessBL, ICustomerCodificationService
    {
            ...
            out Boolean maxRecordsExceded)
        {
            ...
            try
            {
                ...
                List<List<object>> lista = _customerCodificationDA.GetMDSCustomerCodification(0, processChartIDs, step, status, locations,
            ...
            {
                _customerCodificationDA.Dispose();
            }
        }
