...
<div id="AreaTrabajo" style="height:100%;width:100%; padding: 0px;">
	<center>
		...
		<div id="divContenido" style="left: 25px; overflow:auto; width: 940px; position: absolute; top: 130px; height: 552px;" runat="server">
			<asp:Table id="tblCal" style="left:0px; clip:rect(0px 1810px 535px 0px); position:absolute; top:0px;" runat="server" EnableViewState="False"></asp:Table>
	    </div>
	</center>
