    ...
    public partial class Default : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            if (!Page.IsCallback)
            {
                ...
                Master.TituloPagina = "Consulta de salas de reunión por OFICINA";
                ...
                //Master.FicherosCSS.Add("Capa_Presentacion/Salas/ConsultaOfi/HoraDia.css");
		...
		private void CrearHorario(TableRow Fila, string idHorario, string sNombre, int IDSala, string strUbicacion, string strCaracteristicas, bool bHorario, int nRequisitos, string sRequisitos)
		{
            ...
            Cal.Width = Unit.Pixel(130);
            //Cal.TimeStyle.Width = Unit.Pixel(35);
            //Cal.BackgroundStyle.Width = Unit.Pixel(95);
            //Cal.ItemStyle.Width = Unit.Pixel(95);
