...
<div style="Z-INDEX: -1; VISIBILITY: visible; position: absolute; width: 60px; top: 120px;  left: 30px ;height: 57px">
...
<asp:Image ID="Image2" runat="server" ImageUrl="images/imgGestar20.gif" width="150" Height="175" onclick="mostrarAyuda(1);" style="cursor:pointer;" AlternateText="" />
</div>
