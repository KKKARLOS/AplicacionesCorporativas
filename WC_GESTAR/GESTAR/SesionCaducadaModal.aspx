    <%@ Page Language="C#" CodeFile="SesionCaducadaModal.aspx.cs" Inherits="GESTAR.SesionCaducadaModal" %>
<%@ OutputCache Location="None" VaryByParam="None" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<base target="_self" />
    <title> ::: GESTAR ::: - Caducidad de sesión en ventanas modales</title>
...
<input type="hidden" name="hdnErrores" id="hdnErrores" value="SESIONCADUCADA" />
</form>
